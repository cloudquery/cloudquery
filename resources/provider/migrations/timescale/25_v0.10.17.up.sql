...
CREATE TABLE IF NOT EXISTS "aws_ec2_hosts" (
    ...
    "state" text,
    "tags" jsonb,
    CONSTRAINT aws_ec2_hosts_pk PRIMARY KEY(cq_fetch_date,arn),
    UNIQUE(cq_fetch_date,cq_id)
);
...
CREATE TABLE IF NOT EXISTS "aws_ec2_host_instances" (
    ...
    "instance_type" text,
    "owner_id" text,
    CONSTRAINT aws_ec2_host_instances_pk PRIMARY KEY(cq_fetch_date,cq_id),
    UNIQUE(cq_fetch_date,cq_id)
);
CREATE INDEX ON aws_ec2_host_instances (cq_fetch_date, host_cq_id);
SELECT setup_tsdb_child('aws_ec2_host_instances', 'host_cq_id', 'aws_ec2_hosts', 'cq_id');
