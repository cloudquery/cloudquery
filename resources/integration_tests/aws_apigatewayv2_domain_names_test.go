...
//	integration_tests.awsTestIntegrationHelper(t, resources.Apigatewayv2DomainNames(), func(res *providertest.ResourceIntegrationTestData) providertest.ResourceIntegrationVerification {
