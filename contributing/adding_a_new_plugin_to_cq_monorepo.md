...
7. If you want the plugin to appear on the website front page and integration pages, add an entry for it in [pluginData.tsx](../website/components/pluginData.tsx). Also add an `.svg` logo for it in [here](../website/public/images/logos).
