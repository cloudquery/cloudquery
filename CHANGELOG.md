...
* Fixed Telemetry error counting and changed debug telemetry flag to only set open telelmetry handler in debug mode [#340](https://github.com/cloudquery/cloudquery/pull/340)
