...
CREATE TABLE IF NOT EXISTS "k8s_apps_daemon_sets" (
	...
	CONSTRAINT k8s_apps_daemon_sets_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_apps_daemon_set_selector_match_expressions" (
	...
	"operator" text,
	"values" text[],
	CONSTRAINT k8s_apps_daemon_set_selector_match_expressions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (daemon_set_cq_id) REFERENCES k8s_apps_daemon_sets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_apps_daemon_set_status_conditions" (
	...
	"reason" text,
	"message" text,
	CONSTRAINT k8s_apps_daemon_set_status_conditions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (daemon_set_cq_id) REFERENCES k8s_apps_daemon_sets(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_apps_deployments" (
	...
	"status_collision_count" integer,
	CONSTRAINT k8s_apps_deployments_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_apps_deployment_selector_match_expressions" (
	...
	"operator" text,
	"values" text[],
	CONSTRAINT k8s_apps_deployment_selector_match_expressions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (deployment_cq_id) REFERENCES k8s_apps_deployments(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_apps_deployment_status_conditions" (
	...
	"reason" text,
	"message" text,
	CONSTRAINT k8s_apps_deployment_status_conditions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (deployment_cq_id) REFERENCES k8s_apps_deployments(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_apps_replica_sets" (
	...
	"status_available_replicas" integer,
	"status_observed_generation" bigint,
	CONSTRAINT k8s_apps_replica_sets_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_apps_replica_set_selector_match_expressions" (
	...
	"operator" text,
	"values" text[],
	CONSTRAINT k8s_apps_replica_set_selector_match_expressions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (replica_set_cq_id) REFERENCES k8s_apps_replica_sets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_apps_replica_set_status_conditions" (
	...
	"reason" text,
	"message" text,
	CONSTRAINT k8s_apps_replica_set_status_conditions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (replica_set_cq_id) REFERENCES k8s_apps_replica_sets(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_apps_stateful_sets" (
	...
	"status_collision_count" integer,
	"status_available_replicas" integer,
	CONSTRAINT k8s_apps_stateful_sets_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_apps_stateful_set_selector_match_expressions" (
	...
	"operator" text,
	"values" text[],
	CONSTRAINT k8s_apps_stateful_set_selector_match_expressions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (stateful_set_cq_id) REFERENCES k8s_apps_stateful_sets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_apps_stateful_set_status_conditions" (
	...
	"reason" text,
	"message" text,
	CONSTRAINT k8s_apps_stateful_set_status_conditions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (stateful_set_cq_id) REFERENCES k8s_apps_stateful_sets(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_batch_cron_jobs" (
	...
	"status" jsonb,
	CONSTRAINT k8s_batch_cron_jobs_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "k8s_batch_jobs" (
	...
	CONSTRAINT k8s_batch_jobs_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_batch_job_selector_match_expressions" (
	...
	"operator" text,
	"values" text[],
	CONSTRAINT k8s_batch_job_selector_match_expressions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (job_cq_id) REFERENCES k8s_batch_jobs(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_batch_job_status_conditions" (
	...
	"reason" text,
	"message" text,
	CONSTRAINT k8s_batch_job_status_conditions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (job_cq_id) REFERENCES k8s_batch_jobs(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_core_endpoints" (
	...
	"cluster_name" text,
	"managed_fields" jsonb,
	CONSTRAINT k8s_core_endpoints_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_core_endpoint_subsets" (
	...
	"endpoint_name" text,
	"endpoint_uid" text,
	CONSTRAINT k8s_core_endpoint_subsets_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (endpoint_cq_id) REFERENCES k8s_core_endpoints(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_endpoint_subset_addresses" (
	...
	CONSTRAINT k8s_core_endpoint_subset_addresses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (endpoint_subset_cq_id) REFERENCES k8s_core_endpoint_subsets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_endpoint_subset_not_ready_addresses" (
	...
	"target_ref_resource_version" text,
	"target_ref_field_path" text,
	CONSTRAINT k8s_core_endpoint_subset_not_ready_addresses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (endpoint_subset_cq_id) REFERENCES k8s_core_endpoint_subsets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_endpoint_subset_ports" (
	...
	"protocol" text,
	"app_protocol" text,
	CONSTRAINT k8s_core_endpoint_subset_ports_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (endpoint_subset_cq_id) REFERENCES k8s_core_endpoint_subsets(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_core_limit_ranges" (
	...
	"cluster_name" text,
	"managed_fields" jsonb,
	CONSTRAINT k8s_core_limit_ranges_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_core_limit_range_limits" (
	...
	CONSTRAINT k8s_core_limit_range_limits_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (limit_range_cq_id) REFERENCES k8s_core_limit_ranges(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_core_namespaces" (
	...
	"phase" text,
	"conditions" jsonb,
	CONSTRAINT k8s_core_namespaces_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_meta_owner_references" (
	...
	CONSTRAINT k8s_meta_owner_references_pk PRIMARY KEY(resource_uid,owner_uid),
	UNIQUE(cq_id),
	FOREIGN KEY (namespace_cq_id) REFERENCES k8s_core_namespaces(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_core_nodes" (
	...
	"internal_ip" inet,
	"external_ip" inet,
	CONSTRAINT k8s_core_nodes_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_core_node_images" (
	...
	"names" text[],
	"size_bytes" bigint,
	CONSTRAINT k8s_core_node_images_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (node_cq_id) REFERENCES k8s_core_nodes(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_node_volumes_attached" (
	...
	"name" text,
	"device_path" text,
	CONSTRAINT k8s_core_node_volumes_attached_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (node_cq_id) REFERENCES k8s_core_nodes(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_core_pods" (
	...
	"pod_ips" inet[],
	"qos_class" text,
	CONSTRAINT k8s_core_pods_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_init_containers" (
	...
	"stdin_once" boolean,
	"tty" boolean,
	CONSTRAINT k8s_core_pod_init_containers_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_cq_id) REFERENCES k8s_core_pods(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_init_container_ports" (
	...
	"protocol" text,
	"host_ip" text,
	CONSTRAINT k8s_core_pod_init_container_ports_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_init_container_cq_id) REFERENCES k8s_core_pod_init_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_init_container_envs" (
	...
	CONSTRAINT k8s_core_pod_init_container_envs_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_init_container_cq_id) REFERENCES k8s_core_pod_init_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_init_container_volume_mounts" (
	...
	"sub_path_expr" text,
	CONSTRAINT k8s_core_pod_init_container_volume_mounts_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_init_container_cq_id) REFERENCES k8s_core_pod_init_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_init_container_volume_devices" (
	...
	"name" text,
	"device_path" text,
	CONSTRAINT k8s_core_pod_init_container_volume_devices_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_init_container_cq_id) REFERENCES k8s_core_pod_init_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_containers" (
	...
	"stdin_once" boolean,
	"tty" boolean,
	CONSTRAINT k8s_core_pod_containers_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_cq_id) REFERENCES k8s_core_pods(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_container_ports" (
	...
	"protocol" text,
	"host_ip" text,
	CONSTRAINT k8s_core_pod_container_ports_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_container_cq_id) REFERENCES k8s_core_pod_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_container_envs" (
	...
	"value_from_secret_key_ref_key" text,
	"value_from_secret_key_ref_optional" boolean,
	CONSTRAINT k8s_core_pod_container_envs_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_container_cq_id) REFERENCES k8s_core_pod_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_container_volume_mounts" (
	...
	"mount_propagation" text,
	"sub_path_expr" text,
	CONSTRAINT k8s_core_pod_container_volume_mounts_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_container_cq_id) REFERENCES k8s_core_pod_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_container_volume_devices" (
	...
	"name" text,
	"device_path" text,
	CONSTRAINT k8s_core_pod_container_volume_devices_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_container_cq_id) REFERENCES k8s_core_pod_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_ephemeral_containers" (
	...
	"stdin_once" boolean,
	"tty" boolean,
	CONSTRAINT k8s_core_pod_ephemeral_containers_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_cq_id) REFERENCES k8s_core_pods(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_ephemeral_container_ports" (
	...
	"protocol" text,
	"host_ip" text,
	CONSTRAINT k8s_core_pod_ephemeral_container_ports_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_ephemeral_container_cq_id) REFERENCES k8s_core_pod_ephemeral_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_ephemeral_container_envs" (
	...
	"value_from_secret_key_ref_key" text,
	"value_from_secret_key_ref_optional" boolean,
	CONSTRAINT k8s_core_pod_ephemeral_container_envs_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_ephemeral_container_cq_id) REFERENCES k8s_core_pod_ephemeral_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_ephemeral_container_volume_mounts" (
	...
	"mount_propagation" text,
	"sub_path_expr" text,
	CONSTRAINT k8s_core_pod_ephemeral_container_volume_mounts_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_ephemeral_container_cq_id) REFERENCES k8s_core_pod_ephemeral_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_ephemeral_container_volume_devices" (
	...
	"name" text,
	"device_path" text,
	CONSTRAINT k8s_core_pod_ephemeral_container_volume_devices_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_ephemeral_container_cq_id) REFERENCES k8s_core_pod_ephemeral_containers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_volumes" (
	...
	"csi" jsonb,
	"ephemeral" jsonb,
	CONSTRAINT k8s_core_pod_volumes_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_cq_id) REFERENCES k8s_core_pods(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_init_container_statuses" (
	...
	"container_id" text,
	"started" boolean,
	CONSTRAINT k8s_core_pod_init_container_statuses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_cq_id) REFERENCES k8s_core_pods(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_container_statuses" (
	...
	"container_id" text,
	"started" boolean,
	CONSTRAINT k8s_core_pod_container_statuses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_cq_id) REFERENCES k8s_core_pods(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_pod_ephemeral_container_statuses" (
	...
	"container_id" text,
	"started" boolean,
	CONSTRAINT k8s_core_pod_ephemeral_container_statuses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (pod_cq_id) REFERENCES k8s_core_pods(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_core_resource_quotas" (
	...
	"status_hard" jsonb,
	"status_used" jsonb,
	CONSTRAINT k8s_core_resource_quotas_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_core_resource_quota_scope_selector_match_expressions" (
	...
	"operator" text,
	"values" text[],
	CONSTRAINT k8s_core_resource_quota_scope_selector_match_expressions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (resource_quota_cq_id) REFERENCES k8s_core_resource_quotas(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_core_service_accounts" (
	...
	CONSTRAINT k8s_core_service_accounts_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_core_service_account_secrets" (
	...
	"resource_version" text,
	"field_path" text,
	CONSTRAINT k8s_core_service_account_secrets_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (service_account_cq_id) REFERENCES k8s_core_service_accounts(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_core_services" (
	...
	CONSTRAINT k8s_core_services_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_core_service_ports" (
	...
	"node_port" integer,
	CONSTRAINT k8s_core_service_ports_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (service_cq_id) REFERENCES k8s_core_services(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_service_load_balancer_ingresses" (
	...
	"ip" text,
	"hostname" text,
	CONSTRAINT k8s_core_service_load_balancer_ingresses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (service_cq_id) REFERENCES k8s_core_services(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_service_load_balancer_ingress_ports" (
	...
	"protocol" text,
	"error" text,
	CONSTRAINT k8s_core_service_load_balancer_ingress_ports_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (service_load_balancer_ingress_cq_id) REFERENCES k8s_core_service_load_balancer_ingresses(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_core_service_conditions" (
	...
	"reason" text,
	"message" text,
	CONSTRAINT k8s_core_service_conditions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (service_cq_id) REFERENCES k8s_core_services(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_networking_network_policies" (
	...
	"policy_types" text[],
	CONSTRAINT k8s_networking_network_policies_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_networking_network_policy_pod_selector_match_expressions" (
	...
	"operator" text,
	"values" text[],
	CONSTRAINT k8s_networking_network_policy_pod_selector_match_expressions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_policy_cq_id) REFERENCES k8s_networking_network_policies(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_networking_network_policy_ingress" (
	...
	CONSTRAINT k8s_networking_network_policy_ingress_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_policy_cq_id) REFERENCES k8s_networking_network_policies(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_networking_network_policy_ingress_ports" (
	...
	"port_str_val" text,
	"end_port" integer,
	CONSTRAINT k8s_networking_network_policy_ingress_ports_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_policy_ingress_cq_id) REFERENCES k8s_networking_network_policy_ingress(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_networking_network_policy_ingress_from" (
	...
	CONSTRAINT k8s_networking_network_policy_ingress_from_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_policy_ingress_cq_id) REFERENCES k8s_networking_network_policy_ingress(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_networking_network_policy_egress" (
	...
	"network_policy_cq_id" uuid,
	"network_policy_uid" text,
	CONSTRAINT k8s_networking_network_policy_egress_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_policy_cq_id) REFERENCES k8s_networking_network_policies(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_networking_network_policy_egress_ports" (
	...
	"port_str_val" text,
	"end_port" integer,
	CONSTRAINT k8s_networking_network_policy_egress_ports_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_policy_egress_cq_id) REFERENCES k8s_networking_network_policy_egress(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "k8s_networking_network_policy_egress_to" (
	...
	"ip_block_cidr" text,
	"ip_block_except" text[],
	CONSTRAINT k8s_networking_network_policy_egress_to_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_policy_egress_cq_id) REFERENCES k8s_networking_network_policy_egress(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_rbac_role_bindings" (
	...
	"role_ref_kind" text,
	"role_ref_name" text,
	CONSTRAINT k8s_rbac_role_bindings_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_rbac_role_binding_subjects" (
	...
	"name" text,
	"namespace" text,
	CONSTRAINT k8s_rbac_role_binding_subjects_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (role_binding_cq_id) REFERENCES k8s_rbac_role_bindings(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "k8s_rbac_roles" (
	...
	"cluster_name" text,
	"managed_fields" jsonb,
	CONSTRAINT k8s_rbac_roles_pk PRIMARY KEY(uid),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "k8s_rbac_role_rules" (
	...
	CONSTRAINT k8s_rbac_role_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (role_cq_id) REFERENCES k8s_rbac_roles(cq_id) ON DELETE CASCADE
);
