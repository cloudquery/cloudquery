...
func TestIntegrationCoreResourceQuotas(t *testing.T) {
	k8sTestIntegrationHelper(t, resources.CoreResourceQuotas(), nil, func(res *providertest.ResourceIntegrationTestData) providertest.ResourceIntegrationVerification {
