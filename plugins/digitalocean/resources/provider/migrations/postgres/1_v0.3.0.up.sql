...
CREATE TABLE IF NOT EXISTS "digitalocean_accounts" (
	...
	"status" text,
	"status_message" text,
	CONSTRAINT digitalocean_accounts_pk PRIMARY KEY(uuid),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_balance" (
	...
	CONSTRAINT digitalocean_balance_pk PRIMARY KEY(generated_at),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_billing_history" (
	...
	"type" text,
	CONSTRAINT digitalocean_billing_history_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_cdn" (
	...
	"certificate_id" text,
	"custom_domain" text,
	CONSTRAINT digitalocean_cdn_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_certificates" (
	...
	"state" text,
	"type" text,
	CONSTRAINT digitalocean_certificates_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_databases" (
	...
	"tags" text[],
	CONSTRAINT digitalocean_databases_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_database_users" (
	...
	CONSTRAINT digitalocean_database_users_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (database_cq_id) REFERENCES digitalocean_databases(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_database_backups" (
	...
	CONSTRAINT digitalocean_database_backups_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (database_cq_id) REFERENCES digitalocean_databases(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_database_replicas" (
	...
	"private_network_uuid" text,
	"tags" text[],
	CONSTRAINT digitalocean_database_replicas_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (database_cq_id) REFERENCES digitalocean_databases(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_database_firewall_rules" (
	...
	"value" text,
	"created_at" timestamp without time zone,
	CONSTRAINT digitalocean_database_firewall_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (database_cq_id) REFERENCES digitalocean_databases(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_domains" (
	...
	"ttl" bigint,
	"zone_file" text,
	CONSTRAINT digitalocean_domains_pk PRIMARY KEY(name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_domain_records" (
	...
	"flags" bigint,
	"tag" text,
	CONSTRAINT digitalocean_domain_records_pk PRIMARY KEY(id),
	UNIQUE(cq_id),
	FOREIGN KEY (domain_cq_id) REFERENCES digitalocean_domains(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_droplets" (
	...
	"volume_ids" text[],
	"vpc_uuid" text,
	CONSTRAINT digitalocean_droplets_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_droplet_networks_v4" (
	...
	"gateway" inet,
	"type" text,
	CONSTRAINT digitalocean_droplet_networks_v4_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (droplet_cq_id) REFERENCES digitalocean_droplets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_droplet_networks_v6" (
	...
	"gateway" inet,
	"type" text,
	CONSTRAINT digitalocean_droplet_networks_v6_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (droplet_cq_id) REFERENCES digitalocean_droplets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_droplet_neighbors" (
	...
	"droplet_id" bigint,
	"neighbor_id" bigint,
	CONSTRAINT digitalocean_droplet_neighbors_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (droplet_cq_id) REFERENCES digitalocean_droplets(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_firewalls" (
	...
	"tags" text[],
	"created" text,
	CONSTRAINT digitalocean_firewalls_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_firewall_inbound_rules" (
	...
	CONSTRAINT digitalocean_firewall_inbound_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (firewall_cq_id) REFERENCES digitalocean_firewalls(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_firewall_outbound_rules" (
	...
	CONSTRAINT digitalocean_firewall_outbound_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (firewall_cq_id) REFERENCES digitalocean_firewalls(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_firewall_pending_changes" (
	...
	"removing" boolean,
	"status" text,
	CONSTRAINT digitalocean_firewall_pending_changes_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (firewall_cq_id) REFERENCES digitalocean_firewalls(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_firewall_droplets" (
	...
	"droplet_id" bigint,
	"firewall_id" uuid,
	CONSTRAINT digitalocean_firewall_droplets_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (firewall_cq_id) REFERENCES digitalocean_firewalls(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_floating_ips" (
	...
	"region_features" text[],
	"ip" cidr,
	CONSTRAINT digitalocean_floating_ips_pk PRIMARY KEY(ip),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_images" (
	...
	"status" text,
	"error_message" text,
	CONSTRAINT digitalocean_images_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_keys" (
	...
	"fingerprint" text,
	"public_key" text,
	CONSTRAINT digitalocean_keys_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_load_balancers" (
	...
	"vpc_uuid" text,
	CONSTRAINT digitalocean_load_balancers_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_load_balancer_forwarding_rules" (
	...
	CONSTRAINT digitalocean_load_balancer_forwarding_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (load_balancer_cq_id) REFERENCES digitalocean_load_balancers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_load_balancer_droplets" (
	...
	CONSTRAINT digitalocean_load_balancer_droplets_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (load_balancer_cq_id) REFERENCES digitalocean_load_balancers(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_projects" (
	...
	"created_at" text,
	"updated_at" text,
	CONSTRAINT digitalocean_projects_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_project_resources" (
	...
	"links_self" text,
	"status" text,
	CONSTRAINT digitalocean_project_resources_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (project_cq_id) REFERENCES digitalocean_projects(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_regions" (
	...
	"available" boolean,
	"features" text[],
	CONSTRAINT digitalocean_regions_pk PRIMARY KEY(slug),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_registry" (
	...
	"created_at" timestamp without time zone,
	CONSTRAINT digitalocean_registry_pk PRIMARY KEY(name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_registry_repositories" (
	...
	"tag_count" bigint,
	CONSTRAINT digitalocean_registry_repositories_pk PRIMARY KEY(registry_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (registry_cq_id) REFERENCES digitalocean_registry(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_sizes" (
	...
	"transfer" float,
	"description" text,
	CONSTRAINT digitalocean_sizes_pk PRIMARY KEY(slug),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_snapshots" (
	...
	"created" text,
	"tags" text[],
	CONSTRAINT digitalocean_snapshots_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_spaces" (
	...
	"location" text,
	"public" boolean,
	CONSTRAINT digitalocean_spaces_pk PRIMARY KEY(name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_space_cors" (
	...
	CONSTRAINT digitalocean_space_cors_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (space_cq_id) REFERENCES digitalocean_spaces(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "digitalocean_space_acls" (
	...
	"grantee_id" text,
	"uri" text,
	CONSTRAINT digitalocean_space_acls_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (space_cq_id) REFERENCES digitalocean_spaces(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_volumes" (
	...
	"tags" text[],
	CONSTRAINT digitalocean_volumes_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_volume_droplets" (
	...
	"droplet_id" bigint,
	"volume_id" text,
	CONSTRAINT digitalocean_volume_droplets_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (volume_cq_id) REFERENCES digitalocean_volumes(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "digitalocean_vpcs" (
	...
	"created_at" timestamp without time zone,
	"default" boolean,
	CONSTRAINT digitalocean_vpcs_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "digitalocean_vpc_members" (
	...
	"name" text,
	"created_at" timestamp without time zone,
	CONSTRAINT digitalocean_vpc_members_pk PRIMARY KEY(id),
	UNIQUE(cq_id),
	FOREIGN KEY (vpc_cq_id) REFERENCES digitalocean_vpcs(cq_id) ON DELETE CASCADE
);
