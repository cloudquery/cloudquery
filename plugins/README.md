...
Plugins are not used directly, but are used by the [CloudQuery CLI](../cli). For an overview of the CLI, see [the docs](https://www.cloudquery.io/docs/cli/fetch/overview).
