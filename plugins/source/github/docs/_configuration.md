...
spec:
  ...
  spec:
    ...
    # local_cache_path: "" # Optional. Path to a local cache directory. If set, the plugin will cache the GitHub API responses in this directory. Defaults to an empty string (no cache).
```
