...
|domain_name|text|The fully qualified domain name for the certificate, such as wwwexamplecom or examplecom|
...
|extended_key_usages|jsonb|Contains a list of Extended Key Usage X509 v3 extension objects|
