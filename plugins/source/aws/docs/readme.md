...
or, configure your desired profile in the `local_profile` field of your CloudQuery `aws.yml`:
...
The following configuration section can be automatically generated by `cloudquery gen aws`:
