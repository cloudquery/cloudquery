...
export const awsServiceLabelMap: Record<string, string> = {
  ...
  dynamodb: 'DynamoDB',
  ebs: 'Elastic Block Store (Amazon EBS)',
  ec2: 'Elastic Compute Cloud (Amazon EC2)',
  ec2ipam: 'IPAM',
  ec2fastlaunch: 'EC2 Fast Launch',
  ecr: 'Elastic Container Registry (Amazon ECR)',
  ecs: 'Elastic Container Service (Amazon ECS)',
  ...
  fsx: 'FSx',
  gamelift: 'GameLift',
  geo: 'Location Service (Amazon Location)',
  glacier: 'Glacier',
  glue: 'Glue',
