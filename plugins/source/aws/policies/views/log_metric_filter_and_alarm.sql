...
--     on
--         aws_cloudtrail_trails.arn
--         = aws_cloudtrail_trail_event_selectors.trail_arn
-- inner join aws_cloudwatchlogs_metric_filters
--     on
--         aws_cloudtrail_trails.cloudwatch_logs_log_group_name
--         = aws_cloudwatchlogs_metric_filters.log_group_name
-- inner join aws_cloudwatch_alarm_metrics
--     on
--         aws_cloudwatchlogs_metric_filters.name
--         = aws_cloudwatch_alarm_metrics.metric_stat_metric_name
-- inner join
--     aws_cloudwatch_alarms on
--         aws_cloudwatch_alarm_metrics.alarm_cq_id
--         = aws_cloudwatch_alarms._cq_id
-- inner join
