...
type SupportClient interface {
	...
	DescribeCreateCaseOptions(context.Context, *support.DescribeCreateCaseOptionsInput, ...func(*support.Options)) (*support.DescribeCreateCaseOptionsOutput, error)
	...
	DescribeSupportedLanguages(context.Context, *support.DescribeSupportedLanguagesInput, ...func(*support.Options)) (*support.DescribeSupportedLanguagesOutput, error)
