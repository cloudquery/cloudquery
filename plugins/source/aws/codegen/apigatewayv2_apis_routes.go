...
func Apigatewayv2ApisRoutes() *schema.Table {
	...
	return &schema.Table{
		...
		Resolver:  fetchApigatewayv2ApisRoutes,
...
func fetchApigatewayv2ApisRoutes(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- interface{}) error {
