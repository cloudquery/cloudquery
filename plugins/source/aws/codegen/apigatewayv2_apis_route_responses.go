...
func Apigatewayv2ApisRouteResponses() *schema.Table {

	return &schema.Table{
		Name:      "aws_apigatewayv2_routeresponses",
		Resolver:  fetchApigatewayv2ApisRouteResponses,
...
func fetchApigatewayv2ApisRouteResponses(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- interface{}) error {
