...
replace (
	...
	github.com/apache/arrow/go/v14 => github.com/cloudquery/arrow/go/v14 v14.0.0-20231002001222-7ded38b478cd
...
require (
	...
	github.com/cloudquery/plugin-sdk/v4 v4.11.1 // indirect
