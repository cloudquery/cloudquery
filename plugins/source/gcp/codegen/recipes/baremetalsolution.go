	...
	resources := []*Resource{
		{
			...
			ListFunction:        (&baremetalsolution.Client{}).ListInstances,
		...
		},
		{
			...
			Struct:              &pb.Network{},
			PrimaryKeys:         []string{ProjectIdColumn.Name, "name"},
			ListFunction:        (&baremetalsolution.Client{}).ListNetworks,
			RequestStructFields: `Parent: "projects/" + c.ProjectId + "/locations/-",`,
		...
		},
		{
			...
			Struct:              &pb.NfsShare{},
			PrimaryKeys:         []string{ProjectIdColumn.Name, "name"},
			ListFunction:        (&baremetalsolution.Client{}).ListNfsShares,
			RequestStructFields: `Parent: "projects/" + c.ProjectId + "/locations/-",`,
		...
		},
		{
			...
			Struct:              &pb.Volume{},
			PrimaryKeys:         []string{ProjectIdColumn.Name, "name"},
			ListFunction:        (&baremetalsolution.Client{}).ListVolumes,
			RequestStructFields: `Parent: "projects/" + c.ProjectId + "/locations/-",`,
		...
		},
		{
			...
			Struct:              &pb.Lun{},
			PrimaryKeys:         []string{ProjectIdColumn.Name, "name"},
			ListFunction:        (&baremetalsolution.Client{}).ListLuns,
