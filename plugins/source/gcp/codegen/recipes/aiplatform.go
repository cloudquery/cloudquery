...
func init() {
	resources := []*Resource{
		{
			...
			LocationsListFunction: (&aiplatform.JobClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.DatasetClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.EndpointClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.FeaturestoreClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.IndexEndpointClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.IndexClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.MetadataClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.ModelClient{}).ListLocations,
		...
		},
		{
			...
			NewFunction:           aiplatform.NewPipelineClient,
			LocationsListFunction: (&aiplatform.PipelineClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.SpecialistPoolClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.VizierClient{}).ListLocations,
		...
		},
		{
			...
			LocationsListFunction: (&aiplatform.TensorboardClient{}).ListLocations,
	...
	for _, resource := range resources {
		if resource.LocationsListFunction == nil {
			continue
		}
