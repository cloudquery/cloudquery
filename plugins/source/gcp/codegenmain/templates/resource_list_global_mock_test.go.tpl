...
func create{{.Service | ToCamel}}{{.SubService | ToCamel}}() (*client.Services, error) {
...
func Test{{.SubService | ToCamel}}(t *testing.T) {
	client.MockTestHelper(t,  {{.SubService | ToCamel}}(), create{{.Service | ToCamel}}{{.SubService | ToCamel}}, client.TestOptions{})
}
