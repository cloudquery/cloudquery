...
func create{{.SubService | ToCamel}}() (*client.Services, error) {
	...
	mux := httprouter.New()
	mux.GET("/projects/testProject/aggregated/{{.SubService}}", func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		resp := &{{.Service}}.{{.MockListStruct}}AggregatedList{
