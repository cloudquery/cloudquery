...
func create{{.GCPService | ToCamel}}{{.GCPSubService | ToCamel}}() (*client.Services, error) {
	...
	mux := httprouter.New()
	mux.GET("/projects/testProject/global/{{.GCPSubService}}", func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		resp := &{{.GCPService}}.{{.MockListStruct}}List{
			Items: []*{{.GCPService}}.{{.GCPStructName}}{&item},
		}
