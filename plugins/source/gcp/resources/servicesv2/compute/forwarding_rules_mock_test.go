...
type MockForwardingRulesResult struct {
	Items map[string]compute.ForwardingRulesScopedList `json:"items,omitempty"`
}
...
func createForwardingRules() (*client.Services, error) {
	...
	mux.GET("/*filepath", func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		resp := &MockForwardingRulesResult{
			Items: map[string]compute.ForwardingRulesScopedList{
				"": {
					ForwardingRules: []*compute.ForwardingRule{&item},
				},
			},
		}
