...
func FeaturestoreLocations() *schema.Table {
	return &schema.Table{
		Name:        "gcp_aiplatform_featurestore_locations",
...
func fetchFeaturestoreLocations(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- any) error {
