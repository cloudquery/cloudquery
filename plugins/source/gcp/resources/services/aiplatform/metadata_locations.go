...
func MetadataLocations() *schema.Table {
	return &schema.Table{
		Name:        "gcp_aiplatform_metadata_locations",
...
func fetchMetadataLocations(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- any) error {
