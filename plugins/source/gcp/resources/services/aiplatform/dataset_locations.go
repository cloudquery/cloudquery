...
func DatasetLocations() *schema.Table {
	return &schema.Table{
		Name:        "gcp_aiplatform_dataset_locations",
...
func fetchDatasetLocations(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- any) error {
