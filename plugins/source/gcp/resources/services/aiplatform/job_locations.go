...
func JobLocations() *schema.Table {
	return &schema.Table{
		Name:        "gcp_aiplatform_job_locations",
...
func fetchJobLocations(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- any) error {
