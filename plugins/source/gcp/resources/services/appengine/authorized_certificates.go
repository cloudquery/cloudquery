	...
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			},
			{
				...
				Resolver: schema.PathResolver("DomainNames"),
			},
			{
				Name:     "expire_time",
			...
			{
				Name:     "certificate_raw_data",
				Type:     schema.TypeJSON,
				Resolver: schema.PathResolver("CertificateRawData"),
			},
			{
				Name:     "managed_certificate",
				Type:     schema.TypeJSON,
				Resolver: schema.PathResolver("ManagedCertificate"),
			},
			{
				Name:     "visible_domain_mappings",
				Type:     schema.TypeStringArray,
				Resolver: schema.PathResolver("VisibleDomainMappings"),
			},
			{
				Name:     "domain_mappings_count",
				Type:     schema.TypeInt,
				Resolver: schema.PathResolver("DomainMappingsCount"),
			},
		},
	}
}
