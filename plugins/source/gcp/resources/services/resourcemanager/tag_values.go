...
func TagValues() *schema.Table {
	return &schema.Table{
		Name:        "gcp_resourcemanager_tag_values",
		Description: `https://cloud.google.com/resource-manager/reference/rest/v3/tagValues/list`,
		Resolver:    fetchTagValues,
...
func fetchTagValues(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- any) error {
