...
type MockDiskTypesResult struct {
	Items map[string]compute.DiskTypesScopedList `json:"items,omitempty"`
}
...
func createDiskTypes() (*client.Services, error) {
	...
	mux.GET("/*filepath", func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		resp := &MockDiskTypesResult{
			Items: map[string]compute.DiskTypesScopedList{
				"": {
					DiskTypes: []*compute.DiskType{&item},
				},
			},
		}
