...
type MockVpnGatewaysResult struct {
	Items map[string]compute.VpnGatewaysScopedList `json:"items,omitempty"`
}
...
func createVpnGateways() (*client.Services, error) {
	...
	mux.GET("/*filepath", func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		resp := &MockVpnGatewaysResult{
			Items: map[string]compute.VpnGatewaysScopedList{
				"": {
					VpnGateways: []*compute.VpnGateway{&item},
				},
			},
		}
