...
func createSslCertificates() (*client.Services, error) {
	...
	svc, err := compute.NewSslCertificatesRESTClient(context.Background(), option.WithoutAuthentication(), option.WithEndpoint(ts.URL))
	if err != nil {
		return nil, err
	}
	return &client.Services{
		ComputeSslCertificatesClient: svc,
	}, nil
}
