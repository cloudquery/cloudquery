...
func createForwardingRules() (*client.Services, error) {
	...
	svc, err := compute.NewForwardingRulesRESTClient(context.Background(), option.WithoutAuthentication(), option.WithEndpoint(ts.URL))
	if err != nil {
		return nil, err
	}
	return &client.Services{
		ComputeForwardingRulesClient: svc,
	}, nil
}
