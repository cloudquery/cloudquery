...
// Source: k8s.io/client-go/kubernetes/typed/core/v1 (interfaces: ConfigMapsGetter,ConfigMapInterface)
...
// MockConfigMapsGetter is a mock of ConfigMapsGetter interface.
type MockConfigMapsGetter struct {
	ctrl     *gomock.Controller
	recorder *MockConfigMapsGetterMockRecorder
}

// MockConfigMapsGetterMockRecorder is the mock recorder for MockConfigMapsGetter.
type MockConfigMapsGetterMockRecorder struct {
	mock *MockConfigMapsGetter
}

// NewMockConfigMapsGetter creates a new mock instance.
...
func (mr *MockConfigMapsGetterMockRecorder) ConfigMaps(arg0 interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConfigMaps", reflect.TypeOf((*MockConfigMapsGetter)(nil).ConfigMaps), arg0)
}
