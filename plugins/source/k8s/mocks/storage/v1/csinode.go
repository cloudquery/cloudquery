...
// Source: k8s.io/client-go/kubernetes/typed/storage/v1 (interfaces: CSINodesGetter,CSINodeInterface)
...
// MockCSINodesGetter is a mock of CSINodesGetter interface.
type MockCSINodesGetter struct {
	ctrl     *gomock.Controller
	recorder *MockCSINodesGetterMockRecorder
}

// MockCSINodesGetterMockRecorder is the mock recorder for MockCSINodesGetter.
type MockCSINodesGetterMockRecorder struct {
	mock *MockCSINodesGetter
}

// NewMockCSINodesGetter creates a new mock instance.
...
func (mr *MockCSINodesGetterMockRecorder) CSINodes() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CSINodes", reflect.TypeOf((*MockCSINodesGetter)(nil).CSINodes))
}
