...
func createConfigMaps(t *testing.T, ctrl *gomock.Controller) client.Services {
	...
	serviceClient.EXPECT().ConfigMaps(metav1.NamespaceAll).Return(resourceClient)
...
func TestConfigMaps(t *testing.T) {
	client.MockTestHelper(t, ConfigMaps(), createConfigMaps)
}
