...
func createPvcs(t *testing.T, ctrl *gomock.Controller) client.Services {
	...
	serviceClient.EXPECT().PersistentVolumeClaims(metav1.NamespaceAll).Return(resourceClient)
...
func TestPvcs(t *testing.T) {
	client.MockTestHelper(t, Pvcs(), createPvcs)
}
