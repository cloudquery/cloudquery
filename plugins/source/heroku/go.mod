module github.com/cloudquery/cloudquery/plugins/source/heroku
...
replace github.com/cloudquery/plugin-sdk v0.0.10 => /Users/hermanschaaf/code/cloudquery/plugin-sdk