...
func createAppWebhookDeliveries() (client.HerokuService, error) {
...
func TestAppWebhookDelivery(t *testing.T) {
	client.HerokuMockTestHelper(t, AppWebhookDeliveries(), createAppWebhookDeliveries, client.TestOptions{})
}
