...
func BuildpackInstallations() *schema.Table {
	return &schema.Table{
		...
		Transform:   transformers.TransformWithStruct(&heroku.BuildpackInstallation{}),
		Columns:     []schema.Column{},
	}
}

func fetchBuildpackInstallations(ctx context.Context, meta schema.ClientMeta, _ *schema.Resource, res chan<- any) error {
