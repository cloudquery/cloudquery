...
func Peerings() *schema.Table {
	return &schema.Table{
		...
		Transform:   transformers.TransformWithStruct(&heroku.Peering{}),
		Columns:     []schema.Column{},
	}
}

func fetchPeerings(ctx context.Context, meta schema.ClientMeta, _ *schema.Resource, res chan<- any) error {
