...
func createPipelineDeployments() (client.HerokuService, error) {
...
func TestPipelineDeployment(t *testing.T) {
	client.HerokuMockTestHelper(t, PipelineDeployments(), createPipelineDeployments, client.TestOptions{})
}
