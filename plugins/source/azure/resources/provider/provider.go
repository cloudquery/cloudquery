...
func Provider() *provider.Provider {
	return &provider.Provider{
		...
		ResourceMap: map[string]*schema.Table{
			...
			"cosmosdb.mongo_db_databases":           cosmosdb.MongoDBDatabases(),
			"cosmosdb.sql_databases":                cosmosdb.SQLDatabases(),
			"datalake.data_lake_analytics_accounts": datalake.DataLakeAnalyticsAccounts(),
			"datalake.data_lake_store_accounts":     datalake.DataLakeStoreAccounts(),
			...
			"monitor.diagnostic_settings":           monitor.DiagnosticSettings(),
			...
			"storage.blob_services":                 storage.BlobServices(),
			...
			"web.apps":                              web.Apps(),
			"web.site_auth_settings":                web.SiteAuthSettings(),
		},
