...
func createDeviceService() (*client.Services, error) {
	...
	svc, err := armwindowsiot.NewServicesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmwindowsiotDeviceService: svc,
	}, nil
}

func TestDeviceService(t *testing.T) {
	client.MockTestHelper(t, DeviceService(), createDeviceService)
}
