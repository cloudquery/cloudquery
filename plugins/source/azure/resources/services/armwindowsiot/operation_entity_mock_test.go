...
func createOperationEntity() (*client.Services, error) {
	var item armwindowsiot.OperationsClientListResponse
	...
	svc, err := armwindowsiot.NewOperationsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmwindowsiotOperationEntity: svc,
	}, nil
}
