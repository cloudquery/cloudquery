...
func createProjectEnvironmentType() (*client.Services, error) {
	...
	svc, err := armdevcenter.NewProjectEnvironmentTypesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmdevcenterProjectEnvironmentType: svc,
	}, nil
}
