...
func createPrivateZone() (*client.Services, error) {
	...
	svc, err := armprivatedns.NewPrivateZonesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
