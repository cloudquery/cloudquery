...
func createQuotaResource() (*client.Services, error) {
	...
	svc, err := armloadtesting.NewQuotasClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmloadtestingQuotaResource: svc,
	}, nil
}
