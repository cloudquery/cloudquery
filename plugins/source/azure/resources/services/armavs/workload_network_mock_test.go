...
func createWorkloadNetwork() (*client.Services, error) {
	...
	svc, err := armavs.NewWorkloadNetworksClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
