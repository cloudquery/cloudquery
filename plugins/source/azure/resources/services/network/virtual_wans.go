...
func fetchVirtualWans(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- any) error {
	cl := meta.(*client.Client)
	svc, err := armnetwork.NewVirtualWansClient(cl.SubscriptionId, cl.Creds, cl.Options)
	if err != nil {
		return err
	}
