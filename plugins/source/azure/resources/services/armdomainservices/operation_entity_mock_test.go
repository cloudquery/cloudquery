...
func createOperationEntity() (*client.Services, error) {
	...
	svc, err := armdomainservices.NewDomainServiceOperationsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmdomainservicesOperationEntity: svc,
	}, nil
}
