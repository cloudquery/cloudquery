...
func createPrivateEndpointConnection(router *mux.Router) error {
	var item armattestation.PrivateEndpointConnectionsClientListResponse
	if err := faker.FakeObject(&item); err != nil {
		return err
	}

	router.HandleFunc("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Attestation/attestationProviders/{providerName}/privateEndpointConnections", func(w http.ResponseWriter, r *http.Request) {
