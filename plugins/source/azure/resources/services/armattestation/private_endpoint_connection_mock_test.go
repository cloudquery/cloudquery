...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armattestation.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmattestationPrivateEndpointConnection: svc,
	}, nil
}
