...
func createRunCommandDocumentBase() (*client.Services, error) {
	...
	svc, err := armcompute.NewVirtualMachineRunCommandsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmcomputeRunCommandDocumentBase: svc,
	}, nil
}
