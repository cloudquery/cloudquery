...
func createDiskAccess() (*client.Services, error) {
	...
	svc, err := armcompute.NewDiskAccessesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
