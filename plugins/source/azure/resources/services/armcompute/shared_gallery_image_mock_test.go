...
func createSharedGalleryImage() (*client.Services, error) {
	...
	svc, err := armcompute.NewSharedGalleryImagesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmcomputeSharedGalleryImage: svc,
	}, nil
}
