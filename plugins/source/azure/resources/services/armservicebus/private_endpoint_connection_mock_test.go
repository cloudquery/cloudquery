...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armservicebus.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmservicebusPrivateEndpointConnection: svc,
	}, nil
}
