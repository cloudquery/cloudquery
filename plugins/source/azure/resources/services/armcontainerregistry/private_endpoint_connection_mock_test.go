...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armcontainerregistry.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmcontainerregistryPrivateEndpointConnection: svc,
	}, nil
}
