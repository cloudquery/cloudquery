...
func fetchServerDatabaseBlobAuditingPolicies(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- any) error {
	...
	pager := svc.NewListByDatabasePager(group, *p.Name, *ps.Name, nil)
	for pager.More() {
