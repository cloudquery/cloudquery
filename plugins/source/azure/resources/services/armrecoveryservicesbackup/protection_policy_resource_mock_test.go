...
func createProtectionPolicyResource() (*client.Services, error) {
	...
	svc, err := armrecoveryservicesbackup.NewBackupPoliciesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmrecoveryservicesbackupProtectionPolicyResource: svc,
	}, nil
}
