...
func createVpnSite() (*client.Services, error) {
	...
	svc, err := armnetwork.NewVPNSitesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
