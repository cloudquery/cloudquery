...
func createManagerConnection() (*client.Services, error) {
	...
	svc, err := armnetwork.NewSubscriptionNetworkManagerConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmnetworkManagerConnection: svc,
	}, nil
}
