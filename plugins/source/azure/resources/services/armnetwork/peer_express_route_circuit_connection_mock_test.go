...
func createPeerExpressRouteCircuitConnection() (*client.Services, error) {
	...
	svc, err := armnetwork.NewPeerExpressRouteCircuitConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmnetworkPeerExpressRouteCircuitConnection: svc,
	}, nil
}
