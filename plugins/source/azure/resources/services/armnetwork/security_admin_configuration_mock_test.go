...
func createSecurityAdminConfiguration() (*client.Services, error) {
	...
	svc, err := armnetwork.NewSecurityAdminConfigurationsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmnetworkSecurityAdminConfiguration: svc,
	}, nil
}
