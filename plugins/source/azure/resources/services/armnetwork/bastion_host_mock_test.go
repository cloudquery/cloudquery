...
func createBastionHost() (*client.Services, error) {
	...
	svc, err := armnetwork.NewBastionHostsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
