...
func createPrivateCloud() (*client.Services, error) {
	var item armvmwarecloudsimple.PrivateCloudsClientListResponse
	...
	svc, err := armvmwarecloudsimple.NewPrivateCloudsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmvmwarecloudsimplePrivateCloud: svc,
	}, nil
}
