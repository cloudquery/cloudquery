...
func createPrivateCloud(router *mux.Router) error {
	...
	router.HandleFunc("/subscriptions/{subscriptionId}/providers/Microsoft.VMwareCloudSimple/locations/{regionId}/privateClouds", func(w http.ResponseWriter, r *http.Request) {
