...
func createUsage() (*client.Services, error) {
	...
	svc, err := armvmwarecloudsimple.NewUsagesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
