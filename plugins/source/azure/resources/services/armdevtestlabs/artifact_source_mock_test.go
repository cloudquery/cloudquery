...
func createArtifactSource() (*client.Services, error) {
	...
	svc, err := armdevtestlabs.NewArtifactSourcesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmdevtestlabsArtifactSource: svc,
	}, nil
}
