...
func createAssessmentResponse() (*client.Services, error) {
	...
	svc, err := armsecurity.NewAssessmentsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmsecurityAssessmentResponse: svc,
	}, nil
}
