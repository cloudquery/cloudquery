...
func createWorkflow() (*client.Services, error) {
	...
	svc, err := armdevhub.NewWorkflowClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
