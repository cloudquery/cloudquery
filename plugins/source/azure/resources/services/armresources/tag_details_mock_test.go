...
func createTagDetails() (*client.Services, error) {
	...
	svc, err := armresources.NewTagsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
