...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armwebpubsub.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmwebpubsubPrivateEndpointConnection: svc,
	}, nil
}
