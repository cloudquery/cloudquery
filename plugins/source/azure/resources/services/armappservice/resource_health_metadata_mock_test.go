...
func createResourceHealthMetadata() (*client.Services, error) {
	...
	svc, err := armappservice.NewResourceHealthMetadataClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmappserviceResourceHealthMetadata: svc,
	}, nil
}
