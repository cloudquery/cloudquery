...
func createLinkerResource() (*client.Services, error) {
	...
	svc, err := armservicelinker.NewLinkerClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmservicelinkerLinkerResource: svc,
	}, nil
}
