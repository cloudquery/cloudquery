...
func createLabDetails() (*client.Services, error) {
	...
	svc, err := armeducation.NewLabsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
