...
func createStudentDetails() (*client.Services, error) {
	...
	svc, err := armeducation.NewStudentsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmeducationStudentDetails: svc,
	}, nil
}
