...
func createGrantDetails() (*client.Services, error) {
	...
	svc, err := armeducation.NewGrantsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
