...
func createCustomDomainResource() (*client.Services, error) {
	...
	svc, err := armappplatform.NewCustomDomainsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmappplatformCustomDomainResource: svc,
	}, nil
}
