...
func createLocation() (*client.Services, error) {
	...
	svc, err := armstorageimportexport.NewLocationsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmstorageimportexportLocation: svc,
	}, nil
}
