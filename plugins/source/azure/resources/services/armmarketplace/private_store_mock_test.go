...
func createPrivateStore() (*client.Services, error) {
	...
	svc, err := armmarketplace.NewPrivateStoreClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmmarketplacePrivateStore: svc,
	}, nil
}
