...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armmachinelearning.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmmachinelearningPrivateEndpointConnection: svc,
	}, nil
}
