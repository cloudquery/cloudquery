...
func PrivateEndpointConnection() *schema.Table {
	return &schema.Table{
		Name:      "azure_armmachinelearning_private_endpoint_connection",
...
func fetchPrivateEndpointConnection(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- interface{}) error {
	...
	svc, err := armmachinelearning.NewPrivateEndpointConnectionsClient(cl.SubscriptionId, cl.Creds, cl.Options)
	if err != nil {
		return err
	}
