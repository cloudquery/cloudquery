...
func createComputeResource() (*client.Services, error) {
	...
	svc, err := armmachinelearning.NewComputeClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmmachinelearningComputeResource: svc,
	}, nil
}
