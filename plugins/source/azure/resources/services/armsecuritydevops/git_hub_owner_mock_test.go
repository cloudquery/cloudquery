...
func createGitHubOwner() (*client.Services, error) {
	...
	svc, err := armsecuritydevops.NewGitHubOwnerClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmsecuritydevopsGitHubOwner: svc,
	}, nil
}
