...
func createWordpressInstanceResource() (*client.Services, error) {
	...
	svc, err := armworkloads.NewWordpressInstancesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmworkloadsWordpressInstanceResource: svc,
	}, nil
}
