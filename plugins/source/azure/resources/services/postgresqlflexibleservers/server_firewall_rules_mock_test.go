...
func createFirewallRules(router *mux.Router) error {
	...
	router.HandleFunc("/subscriptions/{subscriptionId}/resourceGroups/debug/providers/Microsoft.DBforPostgreSQL/flexibleServers/test string/firewallRules", func(w http.ResponseWriter, r *http.Request) {
