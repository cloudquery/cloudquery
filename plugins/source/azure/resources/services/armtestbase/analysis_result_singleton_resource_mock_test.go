...
func createAnalysisResultSingletonResource() (*client.Services, error) {
	...
	svc, err := armtestbase.NewAnalysisResultsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmtestbaseAnalysisResultSingletonResource: svc,
	}, nil
}
