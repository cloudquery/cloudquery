...
func createUserContract() (*client.Services, error) {
	...
	svc, err := armapimanagement.NewGroupUserClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmapimanagementUserContract: svc,
	}, nil
}
