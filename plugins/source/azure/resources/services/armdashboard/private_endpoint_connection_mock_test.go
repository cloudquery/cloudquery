...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armdashboard.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmdashboardPrivateEndpointConnection: svc,
	}, nil
}
