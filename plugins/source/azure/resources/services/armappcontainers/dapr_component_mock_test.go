...
func createDaprComponent() (*client.Services, error) {
	...
	svc, err := armappcontainers.NewDaprComponentsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmappcontainersDaprComponent: svc,
	}, nil
}
