...
func createGeoBackupPolicy() (*client.Services, error) {
	...
	svc, err := armsynapse.NewSQLPoolGeoBackupPoliciesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
