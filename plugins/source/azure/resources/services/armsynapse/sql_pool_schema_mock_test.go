...
func createSqlPoolSchema() (*client.Services, error) {
	...
	svc, err := armsynapse.NewSQLPoolSchemasClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
