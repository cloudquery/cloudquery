...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armsynapse.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmsynapsePrivateEndpointConnection: svc,
	}, nil
}
