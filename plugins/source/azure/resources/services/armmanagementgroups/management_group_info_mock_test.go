...
func createManagementGroupInfo() (*client.Services, error) {
	...
	svc, err := armmanagementgroups.NewClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmmanagementgroupsManagementGroupInfo: svc,
	}, nil
}
