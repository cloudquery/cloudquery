...
func createChangeResourceResult() (*client.Services, error) {
	...
	svc, err := armchanges.NewClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmchangesChangeResourceResult: svc,
	}, nil
}
