...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armstorage.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmstoragePrivateEndpointConnection: svc,
	}, nil
}
