...
func createOpenShiftCluster() (*client.Services, error) {
	...
	svc, err := armredhatopenshift.NewOpenShiftClustersClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmredhatopenshiftOpenShiftCluster: svc,
	}, nil
}
