...
func createServiceResourceDescription() (*client.Services, error) {
	...
	svc, err := armservicefabricmesh.NewServiceClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmservicefabricmeshServiceResourceDescription: svc,
	}, nil
}
