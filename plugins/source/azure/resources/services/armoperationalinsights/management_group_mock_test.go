...
func createManagementGroup() (*client.Services, error) {
	...
	svc, err := armoperationalinsights.NewManagementGroupsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmoperationalinsightsManagementGroup: svc,
	}, nil
}
