...
func createTimeSeriesDatabaseConnection() (*client.Services, error) {
	...
	svc, err := armdigitaltwins.NewTimeSeriesDatabaseConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmdigitaltwinsTimeSeriesDatabaseConnection: svc,
	}, nil
}
