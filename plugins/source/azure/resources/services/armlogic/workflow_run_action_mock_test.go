...
func createWorkflowRunAction() (*client.Services, error) {
	...
	svc, err := armlogic.NewWorkflowRunActionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
