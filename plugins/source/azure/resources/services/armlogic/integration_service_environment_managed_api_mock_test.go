...
func createIntegrationServiceEnvironmentManagedApi() (*client.Services, error) {
	...
	svc, err := armlogic.NewIntegrationServiceEnvironmentManagedApisClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmlogicIntegrationServiceEnvironmentManagedApi: svc,
	}, nil
}
