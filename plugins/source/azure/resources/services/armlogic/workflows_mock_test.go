...
func createWorkflows() (*client.Services, error) {
	...
	svc, err := armlogic.NewWorkflowsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
