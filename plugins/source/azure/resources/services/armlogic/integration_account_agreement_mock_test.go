...
func createIntegrationAccountAgreement() (*client.Services, error) {
	...
	svc, err := armlogic.NewIntegrationAccountAgreementsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmlogicIntegrationAccountAgreement: svc,
	}, nil
}
