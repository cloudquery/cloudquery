...
func createCurrentUsagesBase() (*client.Services, error) {
	...
	svc, err := armquota.NewUsagesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
