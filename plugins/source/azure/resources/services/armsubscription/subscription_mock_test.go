...
func createSubscription() (*client.Services, error) {
	...
	svc, err := armsubscription.NewSubscriptionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmsubscriptionSubscription: svc,
	}, nil
}
