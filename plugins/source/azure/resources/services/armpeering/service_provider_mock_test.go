...
func createServiceProvider() (*client.Services, error) {
	...
	svc, err := armpeering.NewServiceProvidersClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
