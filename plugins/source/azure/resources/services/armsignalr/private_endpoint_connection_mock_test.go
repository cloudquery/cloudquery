...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armsignalr.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmsignalrPrivateEndpointConnection: svc,
	}, nil
}
