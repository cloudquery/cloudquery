...
func createPrivateEndpointConnection() (*client.Services, error) {
	...
	svc, err := armeventhub.NewPrivateEndpointConnectionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmeventhubPrivateEndpointConnection: svc,
	}, nil
}
