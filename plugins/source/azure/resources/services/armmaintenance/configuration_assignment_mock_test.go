...
func createConfigurationAssignment() (*client.Services, error) {
	...
	svc, err := armmaintenance.NewConfigurationAssignmentsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmmaintenanceConfigurationAssignment: svc,
	}, nil
}
