...
func createDimension() (*client.Services, error) {
	...
	svc, err := armcostmanagement.NewDimensionsClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmcostmanagementDimension: svc,
	}, nil
}
