...
func SingleSignOnResource() *schema.Table {
	return &schema.Table{
		Name:      "azure_armdynatrace_single_sign_on_resource",
		Resolver:  fetchSingleSignOnResource,
...
func fetchSingleSignOnResource(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- interface{}) error {
	...
	svc, err := armdynatrace.NewSingleSignOnClient(cl.SubscriptionId, cl.Creds, cl.Options)
	if err != nil {
		return err
	}
