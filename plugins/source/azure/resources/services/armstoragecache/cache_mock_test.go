...
func createCache() (*client.Services, error) {
	...
	svc, err := armstoragecache.NewCachesClient(client.TestSubscription, &client.MockCreds{}, &arm.ClientOptions{
	...
	return &client.Services{
		ArmstoragecacheCache: svc,
	}, nil
}

func TestCache(t *testing.T) {
	client.MockTestHelper(t, Cache(), createCache)
}
