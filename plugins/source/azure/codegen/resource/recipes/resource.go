	...
	return []*resource.Resource{
		{
			...
			Resolver:   resources.ResourceGroupsClient.NewListPager,
		},
		{
			Service:    "resource",
			SubService: "links",
			Struct:     new(armlinks.ResourceLink),
			Resolver:   links.ResourceLinksClient.NewListAtSubscriptionPager,
		},
		{
			Service:    "resource",
			SubService: "policy_assignments",
			Struct:     new(armpolicy.Assignment),
			Resolver:   policy.AssignmentsClient.NewListPager,
		},
	}
}
