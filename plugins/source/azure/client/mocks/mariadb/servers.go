...
func (m *MockServersClient) Get(arg0 context.Context, arg1, arg2 string, arg3 *armmariadb.ServersClientGetOptions) (armmariadb.ServersClientGetResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(armmariadb.ServersClientGetResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockServersClient) NewListByResourceGroupPager(arg0 string, arg1 *armmariadb.ServersClientListByResourceGroupOptions) *mariadb.RuntimePagerArmmariadbServersClientListByResourceGroupResponse {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewListByResourceGroupPager", arg0, arg1)
	ret0, _ := ret[0].(*mariadb.RuntimePagerArmmariadbServersClientListByResourceGroupResponse)
	return ret0
}
...
func (m *MockServersClient) NewListPager(arg0 *armmariadb.ServersClientListOptions) *mariadb.RuntimePagerArmmariadbServersClientListResponse {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewListPager", arg0)
	ret0, _ := ret[0].(*mariadb.RuntimePagerArmmariadbServersClientListResponse)
	return ret0
}
