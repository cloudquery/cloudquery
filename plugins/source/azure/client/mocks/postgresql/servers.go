...
func (m *MockServersClient) Get(arg0 context.Context, arg1, arg2 string, arg3 *armpostgresql.ServersClientGetOptions) (armpostgresql.ServersClientGetResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(armpostgresql.ServersClientGetResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockServersClient) NewListByResourceGroupPager(arg0 string, arg1 *armpostgresql.ServersClientListByResourceGroupOptions) *postgresql.RuntimePagerArmpostgresqlServersClientListByResourceGroupResponse {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewListByResourceGroupPager", arg0, arg1)
	ret0, _ := ret[0].(*postgresql.RuntimePagerArmpostgresqlServersClientListByResourceGroupResponse)
	return ret0
}
...
func (m *MockServersClient) NewListPager(arg0 *armpostgresql.ServersClientListOptions) *postgresql.RuntimePagerArmpostgresqlServersClientListResponse {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewListPager", arg0)
	ret0, _ := ret[0].(*postgresql.RuntimePagerArmpostgresqlServersClientListResponse)
	return ret0
}
