...
// Source: github.com/cloudquery/cloudquery/plugins/source/azure/client/services (interfaces: ContainerRegistriesClient,ContainerReplicationsClient,ContainerManagedClustersClient)
...
// MockContainerManagedClustersClient is a mock of ContainerManagedClustersClient interface.
type MockContainerManagedClustersClient struct {
	ctrl     *gomock.Controller
	recorder *MockContainerManagedClustersClientMockRecorder
}

// MockContainerManagedClustersClientMockRecorder is the mock recorder for MockContainerManagedClustersClient.
type MockContainerManagedClustersClientMockRecorder struct {
	mock *MockContainerManagedClustersClient
}

// NewMockContainerManagedClustersClient creates a new mock instance.
