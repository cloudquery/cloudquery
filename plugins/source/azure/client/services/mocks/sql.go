...
// MockSQLFirewallsClient is a mock of SQLFirewallsClient interface.
type MockSQLFirewallsClient struct {
	ctrl     *gomock.Controller
	recorder *MockSQLFirewallsClientMockRecorder
}

// MockSQLFirewallsClientMockRecorder is the mock recorder for MockSQLFirewallsClient.
type MockSQLFirewallsClientMockRecorder struct {
	mock *MockSQLFirewallsClient
}

// NewMockSQLFirewallsClient creates a new mock instance.
func NewMockSQLFirewallsClient(ctrl *gomock.Controller) *MockSQLFirewallsClient {
	mock := &MockSQLFirewallsClient{ctrl: ctrl}
	mock.recorder = &MockSQLFirewallsClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSQLFirewallsClient) EXPECT() *MockSQLFirewallsClientMockRecorder {
	return m.recorder
}

// ListByServer mocks base method.
func (m *MockSQLFirewallsClient) ListByServer(arg0 context.Context, arg1, arg2 string) (sql.FirewallRuleListResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSQLFirewallsClientMockRecorder) ListByServer(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByServer", reflect.TypeOf((*MockSQLFirewallsClient)(nil).ListByServer), arg0, arg1, arg2)
}
