...
// Source: github.com/cloudquery/cloudquery/plugins/source/azure/client/services (interfaces: SecurityAutoProvisioningSettingsClient,SecurityContactsClient,SecurityPricingsClient,SecuritySettingsClient,SecurityJitNetworkAccessPoliciesClient,SecurityAssessmentsClient)
...
// MockSecurityJitNetworkAccessPoliciesClient is a mock of SecurityJitNetworkAccessPoliciesClient interface.
type MockSecurityJitNetworkAccessPoliciesClient struct {
	ctrl     *gomock.Controller
	recorder *MockSecurityJitNetworkAccessPoliciesClientMockRecorder
}

// MockSecurityJitNetworkAccessPoliciesClientMockRecorder is the mock recorder for MockSecurityJitNetworkAccessPoliciesClient.
type MockSecurityJitNetworkAccessPoliciesClientMockRecorder struct {
	mock *MockSecurityJitNetworkAccessPoliciesClient
}

// NewMockSecurityJitNetworkAccessPoliciesClient creates a new mock instance.
...
// MockSecurityAssessmentsClient is a mock of SecurityAssessmentsClient interface.
type MockSecurityAssessmentsClient struct {
	ctrl     *gomock.Controller
	recorder *MockSecurityAssessmentsClientMockRecorder
}

// MockSecurityAssessmentsClientMockRecorder is the mock recorder for MockSecurityAssessmentsClient.
type MockSecurityAssessmentsClientMockRecorder struct {
	mock *MockSecurityAssessmentsClient
}

// NewMockSecurityAssessmentsClient creates a new mock instance.
