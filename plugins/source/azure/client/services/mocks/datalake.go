...
// Source: github.com/cloudquery/cloudquery/plugins/source/azure/client/services (interfaces: DataLakeStoreAccountsClient,DataLakeAnalyticsAccountsClient)
...
// MockDataLakeStoreAccountsClient is a mock of DataLakeStoreAccountsClient interface.
type MockDataLakeStoreAccountsClient struct {
	ctrl     *gomock.Controller
	recorder *MockDataLakeStoreAccountsClientMockRecorder
}

// MockDataLakeStoreAccountsClientMockRecorder is the mock recorder for MockDataLakeStoreAccountsClient.
type MockDataLakeStoreAccountsClientMockRecorder struct {
	mock *MockDataLakeStoreAccountsClient
}

// NewMockDataLakeStoreAccountsClient creates a new mock instance.
