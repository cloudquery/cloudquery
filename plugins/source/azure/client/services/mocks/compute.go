...
// Source: github.com/cloudquery/cloudquery/plugins/source/azure/client/services (interfaces: ComputeDisksClient,ComputeVirtualMachinesClient,ComputeVirtualMachineExtensionsClient,ComputeVirtualMachineScaleSetsClient)
...
func (m *MockComputeVirtualMachinesClient) InstanceView(arg0 context.Context, arg1, arg2 string) (compute.VirtualMachineInstanceView, error) {
	m.ctrl.T.Helper()
...
func (mr *MockComputeVirtualMachinesClientMockRecorder) InstanceView(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InstanceView", reflect.TypeOf((*MockComputeVirtualMachinesClient)(nil).InstanceView), arg0, arg1, arg2)
}
