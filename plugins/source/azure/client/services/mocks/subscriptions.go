...
// Source: github.com/cloudquery/cloudquery/plugins/source/azure/client/services (interfaces: SubscriptionsSubscriptionsClient,SubscriptionsTenantsClient)
...
func (m *MockSubscriptionsSubscriptionsClient) NewListLocationsPager(arg0 string, arg1 *armsubscriptions.ClientListLocationsOptions) *runtime.Pager[armsubscriptions.ClientListLocationsResponse] {
	m.ctrl.T.Helper()
...
func (mr *MockSubscriptionsSubscriptionsClientMockRecorder) NewListLocationsPager(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewListLocationsPager", reflect.TypeOf((*MockSubscriptionsSubscriptionsClient)(nil).NewListLocationsPager), arg0, arg1)
}
