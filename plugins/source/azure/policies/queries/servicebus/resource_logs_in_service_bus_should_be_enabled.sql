WITH logging_enabled AS (
  ...
  WHERE l.enabled = TRUE
    ...
    AND (s.diagnostic_settings_resource -> 'properties' -> 'storageAccountId' as diagnostic_settings_resource -> 'properties' ->> 'storageAccountId' as storage_account_id IS NOT NULL OR s.storage_account_id IS DISTINCT FROM '')
