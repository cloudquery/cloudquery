...
\ir ../queries/compute/vms_utilizing_managed_disks.sql
\set check_id '7.2'
\echo "Executing check 7.2"
\ir ../queries/compute/os_and_data_disks_encrypted_with_cmk.sql
\set check_id '7.3'
\echo "Executing check 7.3"
\ir ../queries/compute/unattached_disks_are_encrypted_with_cmk.sql
\set check_id '7.4'
...
\ir ../queries/compute/vhds_not_encrypted.sql
