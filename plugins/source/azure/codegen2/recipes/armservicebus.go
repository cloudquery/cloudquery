...
func Armservicebus() []Table {
	tables := []Table{
      ...
      ListFunc: (&armservicebus.NamespacesClient{}).NewListPager,
		...
		{
      Name: "operation",
      Struct: &armservicebus.Operation{},
      ResponseStruct: &armservicebus.OperationsClientListResponse{},
      Client: &armservicebus.OperationsClient{},
      ListFunc: (&armservicebus.OperationsClient{}).NewListPager,
