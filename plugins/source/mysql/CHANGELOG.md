...
## [2.0.13](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.12...plugins-source-mysql-v2.0.13) (2023-11-03)
...
## [2.0.12](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.11...plugins-source-mysql-v2.0.12) (2023-10-24)
...
## [2.0.11](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.10...plugins-source-mysql-v2.0.11) (2023-10-20)
...
## [2.0.10](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.9...plugins-source-mysql-v2.0.10) (2023-10-04)
...
## [2.0.9](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.8...plugins-source-mysql-v2.0.9) (2023-09-28)
...
* Handle NoConnection ([#14115](https://github.com/cloudquery/cloudquery/issues/14115)) ([d1497ac](https://github.com/cloudquery/cloudquery/commit/d1497ac3417c746a8f5b922c43d45906d035b213))
...
## [2.0.5](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.4...plugins-source-mysql-v2.0.5) (2023-08-29)
...
## [2.0.4](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.3...plugins-source-mysql-v2.0.4) (2023-08-15)
...
## [2.0.3](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.2...plugins-source-mysql-v2.0.3) (2023-08-08)
...
## [2.0.2](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.1...plugins-source-mysql-v2.0.2) (2023-07-25)
...
## [2.0.1](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v2.0.0...plugins-source-mysql-v2.0.1) (2023-07-18)
...
## [2.0.0](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v1.2.2...plugins-source-mysql-v2.0.0) (2023-07-17)
...
* Update to use [Apache Arrow](https://arrow.apache.org/) type system ([#11214](https://github.com/cloudquery/cloudquery/issues/11214)) ([de2ae04](https://github.com/cloudquery/cloudquery/commit/de2ae040cefe0971e89bbe37d5ffd0aab3c5781a))
* Upgrades the mysql source plugin to use plugin-sdk v4. This version does not contain any user-facing breaking changes, but because it is now using CloudQuery gRPC protocol v3, it does require use of a destination plugin that also supports protocol v3. All recent destination plugin versions support this. ([1e8d0f8](https://github.com/cloudquery/cloudquery/commit/1e8d0f805d2f236e6243424dffd4d0adcd658cb4))
...
## [1.2.0](https://github.com/cloudquery/cloudquery/compare/plugins-source-mysql-v1.1.1...plugins-source-mysql-v1.2.0) (2023-06-06)
