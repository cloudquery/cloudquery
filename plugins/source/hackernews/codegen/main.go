...
import (
	...
	"github.com/cloudquery/cloudquery/plugins/source/hackernews/codegen/recipes"
...
func main() {
	...
	resources = append(resources, recipes.ItemResources()...)
...
func generateTable(basedir string, r recipes.Resource) {
	...
	r.TableName = "hackernews_" + r.TableName
	...
	if err != nil {
		log.Fatal(fmt.Errorf("failed to parse hackernews templates: %w", err))
	}
