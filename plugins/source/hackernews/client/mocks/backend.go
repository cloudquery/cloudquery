...
//
//	mockgen -package=mocks -destination=../mocks/backend.go -source=backend.go BackendClient
//
...
func (mr *MockBackendClientMockRecorder) Flush(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBackendClientMockRecorder) GetKey(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBackendClientMockRecorder) SetKey(ctx, key, value any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
