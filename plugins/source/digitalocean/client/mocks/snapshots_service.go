...
// Source: github.com/cloudquery/cloudquery/plugins/source/digitalocean/client (interfaces: SnapshotsService)
...
func (mr *MockSnapshotsServiceMockRecorder) List(arg0, arg1 interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockSnapshotsService)(nil).List), arg0, arg1)
}
