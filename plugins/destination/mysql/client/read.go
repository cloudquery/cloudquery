...
func reverseTransform(table *arrow.Schema, values []any) (arrow.RecordBatch, error) {
	...
	for i, val := range values {
		...
		default:
			...
			if !v.Valid {
				...
				if err := appendFromString(recordBuilder.Field(i), val.(*sql.NullString).String); err != nil {
