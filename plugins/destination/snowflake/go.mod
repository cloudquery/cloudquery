...
require (
	...
	github.com/aws/aws-sdk-go-v2/credentials v1.13.17 // indirect; indirect // indirect
	github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.11.58 // indirect; indirect // indirect
