...
require (
	...
	github.com/cloudquery/plugin-sdk/v2 v2.7.1-0.20230509110840-cdca89f24ed1
...
// TMP: for test only
replace github.com/cloudquery/plugin-sdk/v2 => github.com/cloudquery/plugin-sdk/v2 v2.7.1-0.20230509110840-cdca89f24ed1
