from pyarrow import DataType, binary, large_binary, string, large_string, int64, int8, int16, int32, uint8, uint16, uint32, uint64, float16, float32, float64, bool_, timestamp
...
def arrow_type_to_sqlite_str(t: DataType) -> str:
    if t.equals(binary()) or t.equals(large_binary()):
        ...
        return "text"
    elif t.equals(int8()) or t.equals(int16()) or t.equals(int32()) or t.equals(int64()) or t.equals(uint8()) or t.equals(uint16()) or t.equals(uint32()) or t.equals(uint64()):
        return "integer"
