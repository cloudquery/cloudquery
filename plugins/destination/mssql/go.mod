...
require (
	github.com/Azure/azure-sdk-for-go/sdk/azcore v1.4.0 // indirect; indirect // indirect
	github.com/Azure/azure-sdk-for-go/sdk/azidentity v1.2.2 // indirect; indirect // indirect
