...
require (
	...
	github.com/cloudquery/plugin-pb-go v1.20.0 // indirect
...
replace github.com/cloudquery/plugin-sdk/v4 => github.com/cloudquery/plugin-sdk/v4 v4.45.2-0.20240614164836-3dc0b31dcdf5
