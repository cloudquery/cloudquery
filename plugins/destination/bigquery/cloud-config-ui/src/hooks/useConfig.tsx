          ...
          children: [
            {
              ...
              children: [
                ...
                //       schema: yup
                //         .string()
                //         .default(initialValues?.spec?.fastly_api_key ?? '')
                //         .required(),
                //     },
                //   ],
                // },
                ...
                },
                {
                  ...
                  helperText: (
                    <>
                      ...
                      used will always be <b>_cq_sync_time</b> so that all rows for a sync run will
                      be partitioned on the hour/day the sync started.
                    </>
                  ),
      ...
      guide: {
        ...
        sections: [
            ...
            bodies: [
              {
                text: (
                  <>
                    The BigQuery destination lets you sync data from any CloudQuery source to a
                    BigQuery&#8209;compatible database.
                  </>
                ),
              },
            ],
          },
          {
            ...
            bodies: [
              {
                text: `To allow CloudQuery network access to your BigQuery instance, make sure the following
