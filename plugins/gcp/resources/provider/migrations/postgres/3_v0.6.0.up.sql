...
CREATE TABLE IF NOT EXISTS "gcp_bigquery_datasets" (
	...
	"self_link" text,
	CONSTRAINT gcp_bigquery_datasets_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_bigquery_dataset_accesses" (
	...
	"view_table_id" text,
	CONSTRAINT gcp_bigquery_dataset_accesses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (dataset_cq_id) REFERENCES gcp_bigquery_datasets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_bigquery_dataset_tables" (
	...
	CONSTRAINT gcp_bigquery_dataset_tables_pk PRIMARY KEY(dataset_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (dataset_cq_id) REFERENCES gcp_bigquery_datasets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_bigquery_dataset_table_dataset_model_training_runs" (
	...
	CONSTRAINT gcp_bigquery_dataset_table_dataset_model_training_runs_pk PRIMARY KEY(dataset_table_cq_id,start_time),
	UNIQUE(cq_id),
	FOREIGN KEY (dataset_table_cq_id) REFERENCES gcp_bigquery_dataset_tables(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_bigquery_dataset_table_user_defined_functions" (
	...
	"inline_code" text,
	"resource_uri" text,
	CONSTRAINT gcp_bigquery_dataset_table_user_defined_functions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (dataset_table_cq_id) REFERENCES gcp_bigquery_dataset_tables(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_cloudfunctions_functions" (
	...
	CONSTRAINT gcp_cloudfunctions_functions_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_addresses" (
	...
	"subnetwork" text,
	"users" text[],
	CONSTRAINT gcp_compute_addresses_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_autoscalers" (
	...
	"target" text,
	"zone" text,
	CONSTRAINT gcp_compute_autoscalers_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_autoscaler_custom_metric_utilizations" (
	...
	CONSTRAINT gcp_compute_autoscaler_custom_metric_utilizations_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (autoscaler_cq_id) REFERENCES gcp_compute_autoscalers(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_backend_services" (
	...
	"timeout_sec" bigint,
	CONSTRAINT gcp_compute_backend_services_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_backend_service_backends" (
	...
	CONSTRAINT gcp_compute_backend_service_backends_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (backend_service_cq_id) REFERENCES gcp_compute_backend_services(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_disk_types" (
	...
	"zone" text,
	CONSTRAINT gcp_compute_disk_types_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_disks" (
	...
	"users" text[],
	"zone" text,
	CONSTRAINT gcp_compute_disks_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_firewalls" (
	...
	"target_tags" text[],
	CONSTRAINT gcp_compute_firewalls_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_firewall_allowed" (
	...
	"ip_protocol" text,
	"ports" text[],
	CONSTRAINT gcp_compute_firewall_allowed_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (firewall_cq_id) REFERENCES gcp_compute_firewalls(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_firewall_denied" (
	...
	"ip_protocol" text,
	"ports" text[],
	CONSTRAINT gcp_compute_firewall_denied_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (firewall_cq_id) REFERENCES gcp_compute_firewalls(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_forwarding_rules" (
	...
	"subnetwork" text,
	"target" text,
	CONSTRAINT gcp_compute_forwarding_rules_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_images" (
	...
	CONSTRAINT gcp_compute_images_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_instances" (
	...
	"tags_items" text[],
	"zone" text,
	CONSTRAINT gcp_compute_instances_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_instance_disks" (
	...
	"source" text,
	"type" text,
	CONSTRAINT gcp_compute_instance_disks_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES gcp_compute_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_instance_network_interfaces" (
	...
	"nic_type" text,
	"subnetwork" text,
	CONSTRAINT gcp_compute_instance_network_interfaces_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES gcp_compute_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_instance_network_interface_access_configs" (
	...
	"type" text,
	CONSTRAINT gcp_compute_instance_network_interface_access_configs_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_network_interface_cq_id) REFERENCES gcp_compute_instance_network_interfaces(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_instance_network_interface_alias_ip_ranges" (
	...
	CONSTRAINT gcp_compute_instance_network_interface_alias_ip_ranges_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_network_interface_cq_id) REFERENCES gcp_compute_instance_network_interfaces(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_instance_scheduling_node_affinities" (
	...
	"operator" text,
	"values" text[],
	CONSTRAINT gcp_compute_instance_scheduling_node_affinities_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES gcp_compute_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_instance_service_accounts" (
	...
	"email" text,
	"scopes" text[],
	CONSTRAINT gcp_compute_instance_service_accounts_pk PRIMARY KEY(instance_cq_id,email),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES gcp_compute_instances(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_interconnects" (
	...
	"self_link" text,
	"state" text,
	CONSTRAINT gcp_compute_interconnects_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_interconnect_circuit_infos" (
	...
	CONSTRAINT gcp_compute_interconnect_circuit_infos_pk PRIMARY KEY(interconnect_cq_id,google_circuit_id),
	UNIQUE(cq_id),
	FOREIGN KEY (interconnect_cq_id) REFERENCES gcp_compute_interconnects(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_interconnect_expected_outages" (
	...
	"start_time" bigint,
	"state" text,
	CONSTRAINT gcp_compute_interconnect_expected_outages_pk PRIMARY KEY(interconnect_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (interconnect_cq_id) REFERENCES gcp_compute_interconnects(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_networks" (
	...
	"self_link" text,
	"subnetworks" text[],
	CONSTRAINT gcp_compute_networks_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_network_peerings" (
	...
	"state" text,
	"state_details" text,
	CONSTRAINT gcp_compute_network_peerings_pk PRIMARY KEY(network_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (network_cq_id) REFERENCES gcp_compute_networks(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_projects" (
	...
	CONSTRAINT gcp_compute_projects_pk PRIMARY KEY(project_id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_project_quotas" (
	...
	"owner" text,
	"usage" float,
	CONSTRAINT gcp_compute_project_quotas_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (project_cq_id) REFERENCES gcp_compute_projects(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_ssl_certificates" (
	...
	"type" text,
	CONSTRAINT gcp_compute_ssl_certificates_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_ssl_policies" (
	...
	"profile" text,
	"self_link" text,
	CONSTRAINT gcp_compute_ssl_policies_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_ssl_policy_warnings" (
	...
	"data" jsonb,
	"message" text,
	CONSTRAINT gcp_compute_ssl_policy_warnings_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (ssl_policy_cq_id) REFERENCES gcp_compute_ssl_policies(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_subnetworks" (
	...
	"self_link" text,
	"state" text,
	CONSTRAINT gcp_compute_subnetworks_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_subnetwork_secondary_ip_ranges" (
	...
	"ip_cidr_range" text,
	"range_name" text,
	CONSTRAINT gcp_compute_subnetwork_secondary_ip_ranges_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (subnetwork_cq_id) REFERENCES gcp_compute_subnetworks(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_target_https_proxies" (
	...
	"ssl_policy" text,
	"url_map" text,
	CONSTRAINT gcp_compute_target_https_proxies_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_target_ssl_proxies" (
	...
	"ssl_certificates" text[],
	"ssl_policy" text,
	CONSTRAINT gcp_compute_target_ssl_proxies_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_url_maps" (
	...
	"region" text,
	"self_link" text,
	CONSTRAINT gcp_compute_url_maps_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_url_map_weighted_backend_services" (
	...
	"header_action" jsonb,
	"weight" bigint,
	CONSTRAINT gcp_compute_url_map_weighted_backend_services_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (url_map_cq_id) REFERENCES gcp_compute_url_maps(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_url_map_host_rules" (
	...
	"hosts" text[],
	"path_matcher" text,
	CONSTRAINT gcp_compute_url_map_host_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (url_map_cq_id) REFERENCES gcp_compute_url_maps(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_url_map_path_matchers" (
	...
	"path_rules" jsonb,
	"route_rules" jsonb,
	CONSTRAINT gcp_compute_url_map_path_matchers_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (url_map_cq_id) REFERENCES gcp_compute_url_maps(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_compute_url_map_tests" (
	...
	"path" text,
	"service" text,
	CONSTRAINT gcp_compute_url_map_tests_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (url_map_cq_id) REFERENCES gcp_compute_url_maps(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_compute_vpn_gateways" (
	...
	"region" text,
	"self_link" text,
	CONSTRAINT gcp_compute_vpn_gateways_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_compute_vpn_gateway_vpn_interfaces" (
	...
	"ip_address" text,
	CONSTRAINT gcp_compute_vpn_gateway_vpn_interfaces_pk PRIMARY KEY(vpn_gateway_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (vpn_gateway_cq_id) REFERENCES gcp_compute_vpn_gateways(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_dns_managed_zones" (
	...
	"visibility" text,
	CONSTRAINT gcp_dns_managed_zones_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_dns_managed_zone_dnssec_config_default_key_specs" (
	...
	"key_type" text,
	"kind" text,
	CONSTRAINT gcp_dns_managed_zone_dnssec_config_default_key_specs_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (managed_zone_cq_id) REFERENCES gcp_dns_managed_zones(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_dns_managed_zone_forwarding_config_target_name_servers" (
	...
	"ipv4_address" text,
	"kind" text,
	CONSTRAINT gcp_dns_managed_zone_forwarding_config_target_name_servers_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (managed_zone_cq_id) REFERENCES gcp_dns_managed_zones(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_dns_managed_zone_private_visibility_config_networks" (
	...
	"kind" text,
	"network_url" text,
	CONSTRAINT gcp_dns_managed_zone_private_visibility_config_networks_pk PRIMARY KEY(managed_zone_cq_id,network_url),
	UNIQUE(cq_id),
	FOREIGN KEY (managed_zone_cq_id) REFERENCES gcp_dns_managed_zones(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_dns_policies" (
	...
	"kind" text,
	"name" text,
	CONSTRAINT gcp_dns_policies_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_dns_policy_alternative_name_servers" (
	...
	"ipv4_address" text,
	"kind" text,
	CONSTRAINT gcp_dns_policy_alternative_name_servers_pk PRIMARY KEY(policy_cq_id,ipv4_address),
	UNIQUE(cq_id),
	FOREIGN KEY (policy_cq_id) REFERENCES gcp_dns_policies(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_dns_policy_networks" (
	...
	"kind" text,
	"network_url" text,
	CONSTRAINT gcp_dns_policy_networks_pk PRIMARY KEY(policy_cq_id,network_url),
	UNIQUE(cq_id),
	FOREIGN KEY (policy_cq_id) REFERENCES gcp_dns_policies(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_domains_registrations" (
	...
	CONSTRAINT gcp_domains_registrations_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_domains_registration_glue_records" (
	...
	"ipv4_addresses" text[],
	"ipv6_addresses" text[],
	CONSTRAINT gcp_domains_registration_glue_records_pk PRIMARY KEY(registration_cq_id,host_name),
	UNIQUE(cq_id),
	FOREIGN KEY (registration_cq_id) REFERENCES gcp_domains_registrations(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_iam_roles" (
	...
	"stage" text,
	"title" text,
	CONSTRAINT gcp_iam_roles_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_iam_service_accounts" (
	...
	"project_id" text,
	"id" text,
	CONSTRAINT gcp_iam_service_accounts_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_iam_service_account_keys" (
	...
	CONSTRAINT gcp_iam_service_account_keys_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (service_account_cq_id) REFERENCES gcp_iam_service_accounts(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_kms_keyrings" (
	...
	"name" text,
	CONSTRAINT gcp_kms_keyrings_pk PRIMARY KEY(project_id,location,name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_kms_keyring_crypto_keys" (
	...
	CONSTRAINT gcp_kms_keyring_crypto_keys_pk PRIMARY KEY(keyring_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (keyring_cq_id) REFERENCES gcp_kms_keyrings(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_logging_metrics" (
	...
	"version" text,
	CONSTRAINT gcp_logging_metrics_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_logging_metric_descriptor_labels" (
	...
	"key" text,
	"value_type" text,
	CONSTRAINT gcp_logging_metric_descriptor_labels_pk PRIMARY KEY(metric_cq_id,key),
	UNIQUE(cq_id),
	FOREIGN KEY (metric_cq_id) REFERENCES gcp_logging_metrics(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_logging_sinks" (
	...
	CONSTRAINT gcp_logging_sinks_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_logging_sink_exclusions" (
	...
	"name" text,
	"update_time" text,
	CONSTRAINT gcp_logging_sink_exclusions_pk PRIMARY KEY(sink_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (sink_cq_id) REFERENCES gcp_logging_sinks(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_monitoring_alert_policies" (
	...
	CONSTRAINT gcp_monitoring_alert_policies_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_monitoring_alert_policy_conditions" (
	...
	"display_name" text,
	"name" text,
	CONSTRAINT gcp_monitoring_alert_policy_conditions_pk PRIMARY KEY(alert_policy_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (alert_policy_cq_id) REFERENCES gcp_monitoring_alert_policies(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_monitoring_alert_policy_condition_absent_aggregations" (
	...
	CONSTRAINT gcp_monitoring_alert_policy_condition_absent_aggregations_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (alert_policy_condition_cq_id) REFERENCES gcp_monitoring_alert_policy_conditions(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_monitoring_alert_policy_condition_threshold_aggregations" (
	...
	"group_by_fields" text[],
	"per_series_aligner" text,
	CONSTRAINT gcp_monitoring_alert_policy_condition_threshold_aggregations_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (alert_policy_condition_cq_id) REFERENCES gcp_monitoring_alert_policy_conditions(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_monitoring_alert_policy_condition_denominator_aggs" (
	...
	"group_by_fields" text[],
	"per_series_aligner" text,
	CONSTRAINT gcp_monitoring_alert_policy_condition_denominator_aggs_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (alert_policy_condition_cq_id) REFERENCES gcp_monitoring_alert_policy_conditions(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_resource_manager_folders" (
	...
	CONSTRAINT gcp_resource_manager_folders_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_resource_manager_projects" (
	...
	"state" text,
	"update_time" timestamp without time zone,
	CONSTRAINT gcp_resource_manager_projects_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "gcp_sql_instances" (
	...
	CONSTRAINT gcp_sql_instances_pk PRIMARY KEY(project_id,name),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_sql_instance_ip_addresses" (
	...
	"time_to_retire" text,
	"type" text,
	CONSTRAINT gcp_sql_instance_ip_addresses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES gcp_sql_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_sql_instance_settings_deny_maintenance_periods" (
	...
	"start_date" text,
	"time" text,
	CONSTRAINT gcp_sql_instance_settings_deny_maintenance_periods_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES gcp_sql_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_sql_instance_settings_ip_config_authorized_networks" (
	...
	"name" text,
	"value" text,
	CONSTRAINT gcp_sql_instance_settings_ip_config_authorized_networks_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES gcp_sql_instances(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "gcp_storage_buckets" (
	...
	"zone_affinity" text[],
	"policy" jsonb,
	CONSTRAINT gcp_storage_buckets_pk PRIMARY KEY(project_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "gcp_storage_bucket_acls" (
	...
	"role" text,
	"self_link" text,
	CONSTRAINT gcp_storage_bucket_acls_pk PRIMARY KEY(bucket_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (bucket_cq_id) REFERENCES gcp_storage_buckets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_storage_bucket_cors" (
	...
	CONSTRAINT gcp_storage_bucket_cors_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (bucket_cq_id) REFERENCES gcp_storage_buckets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_storage_bucket_default_object_acls" (
	...
	"role" text,
	"self_link" text,
	CONSTRAINT gcp_storage_bucket_default_object_acls_pk PRIMARY KEY(bucket_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (bucket_cq_id) REFERENCES gcp_storage_buckets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "gcp_storage_bucket_lifecycle_rules" (
	...
	CONSTRAINT gcp_storage_bucket_lifecycle_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (bucket_cq_id) REFERENCES gcp_storage_buckets(cq_id) ON DELETE CASCADE
);
