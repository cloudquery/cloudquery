	...
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("IpAllocationPolicy.ClusterIpv4Cidr"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("IpAllocationPolicy.ClusterIpv4CidrBlock"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
			...
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("IpAllocationPolicy.NodeIpv4Cidr"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("IpAllocationPolicy.NodeIpv4CidrBlock"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("IpAllocationPolicy.ServicesIpv4Cidr"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("IpAllocationPolicy.ServicesIpv4CidrBlock"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
			...
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("IpAllocationPolicy.TpuIpv4CidrBlock"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
			...
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("PrivateClusterConfig.MasterIpv4CidrBlock"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
			...
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("ServicesIpv4Cidr"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
			...
			},
			{
				...
				Type:          schema.TypeCIDR,
				Resolver:      schema.IPNetResolver("TpuIpv4CidrBlock"),
				IgnoreError:   client.IgnoreErrorColumnHandler,
				IgnoreInTests: true,
			},
			{
		...
		Relations: []*schema.Table{
			{
				...
				Columns: []schema.Column{
					...
					},
					{
						...
						Type:          schema.TypeCIDR,
						Resolver:      schema.IPNetResolver("NetworkConfig.PodIpv4CidrBlock"),
						IgnoreError:   client.IgnoreErrorColumnHandler,
						IgnoreInTests: true,
					},
					{
