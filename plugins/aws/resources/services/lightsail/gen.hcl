...
resource "aws" "lightsail" "databases" {
  ...
  user_relation "aws" "lightsail" "log_events" {
    path            = "github.com/cloudquery/cloudquery/plugins/aws/resources/services/lightsail.LogEventWrapper"
    ignore_in_tests = true
...
resource "aws" "lightsail" "distributions" {
  path = "github.com/cloudquery/cloudquery/plugins/aws/resources/services/lightsail.DistributionWrapper"
