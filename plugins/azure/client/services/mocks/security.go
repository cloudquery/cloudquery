...
// Source: github.com/cloudquery/cq-provider-azure/client/services (interfaces: SecurityAutoProvisioningSettingsClient,SecurityContactsClient,SecurityPricingsClient,SecuritySettingsClient)
