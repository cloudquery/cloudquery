...
// Source: github.com/cloudquery/cq-provider-azure/client/services (interfaces: InterfacesClient,VirtualNetworksClient,SecurityGroupsClient,WatchersClient,PublicIPAddressesClient)
