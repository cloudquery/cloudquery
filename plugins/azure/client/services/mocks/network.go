...
// Source: github.com/cloudquery/cq-provider-azure/client/services (interfaces: VirtualNetworksClient,SecurityGroupsClient,WatchersClient,PublicIPAddressesClient,InterfacesClient)
