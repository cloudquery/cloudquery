...
// Source: github.com/cloudquery/cq-provider-azure/client/services (interfaces: DisksClient,GroupsClient,StorageAccountClient,StorageContainerClient,MySQLServerClient,MySQLConfigurationClient)
