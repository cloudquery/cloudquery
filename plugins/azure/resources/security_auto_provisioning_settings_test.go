...
func buildSecurityAutoProvisioningSettings(t *testing.T, ctrl *gomock.Controller) services.Services {
...
func TestSecurityAutoProvisioningSettings(t *testing.T) {
	azureTestHelper(t, resources.SecurityAutoProvisioningSettings(), buildSecurityAutoProvisioningSettings)
}
