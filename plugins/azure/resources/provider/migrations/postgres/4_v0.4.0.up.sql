...
CREATE TABLE IF NOT EXISTS "azure_authorization_role_assignments" (
	...
	"principal_id" text,
	CONSTRAINT azure_authorization_role_assignments_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_authorization_role_definitions" (
	...
	CONSTRAINT azure_authorization_role_definitions_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_authorization_role_definition_permissions" (
	...
	"actions" text[],
	"not_actions" text[],
	CONSTRAINT azure_authorization_role_definition_permissions_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (role_definition_cq_id) REFERENCES azure_authorization_role_definitions(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_compute_disks" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_compute_disks_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_compute_disk_encryption_settings" (
	...
	CONSTRAINT azure_compute_disk_encryption_settings_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (disk_cq_id) REFERENCES azure_compute_disks(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_compute_virtual_machines" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_compute_virtual_machines_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_compute_virtual_machine_win_config_rm_listeners" (
	...
	CONSTRAINT azure_compute_virtual_machine_win_config_rm_listeners_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
...
CREATE TABLE IF NOT EXISTS "azure_compute_virtual_machine_secrets" (
	...
	CONSTRAINT azure_compute_virtual_machine_secrets_pk PRIMARY KEY(virtual_machine_cq_id,source_vault_id),
	UNIQUE(cq_id),
	FOREIGN KEY (virtual_machine_cq_id) REFERENCES azure_compute_virtual_machines(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_compute_virtual_machine_secret_vault_certificates" (
	...
	CONSTRAINT azure_compute_virtual_machine_secret_vault_certificates_pk PRIMARY KEY(virtual_machine_secret_cq_id,certificate_url),
	UNIQUE(cq_id),
	FOREIGN KEY (virtual_machine_secret_cq_id) REFERENCES azure_compute_virtual_machine_secrets(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_compute_virtual_machine_resources" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_compute_virtual_machine_resources_pk PRIMARY KEY(virtual_machine_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (virtual_machine_cq_id) REFERENCES azure_compute_virtual_machines(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_container_managed_clusters" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_container_managed_clusters_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_container_managed_cluster_pip_user_assigned_id_exceptions" (
	...
	"namespace" text,
	"pod_labels" jsonb,
	CONSTRAINT azure_container_managed_cluster_pip_user_assigned_id_excepti_pk PRIMARY KEY(managed_cluster_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (managed_cluster_cq_id) REFERENCES azure_container_managed_clusters(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_container_managed_cluster_private_link_resources" (
	...
	CONSTRAINT azure_container_managed_cluster_private_link_resources_pk PRIMARY KEY(managed_cluster_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (managed_cluster_cq_id) REFERENCES azure_container_managed_clusters(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_container_managed_cluster_agent_pool_profiles" (
	...
	CONSTRAINT azure_container_managed_cluster_agent_pool_profiles_pk PRIMARY KEY(managed_cluster_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (managed_cluster_cq_id) REFERENCES azure_container_managed_clusters(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_container_managed_cluster_pip_user_assigned_identities" (
	...
	"provisioning_state" text,
	CONSTRAINT azure_container_managed_cluster_pip_user_assigned_identities_pk PRIMARY KEY(managed_cluster_cq_id,name),
	UNIQUE(cq_id),
	FOREIGN KEY (managed_cluster_cq_id) REFERENCES azure_container_managed_clusters(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_keyvault_vaults" (
	...
	CONSTRAINT azure_keyvault_vaults_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_keyvault_vault_access_policies" (
	...
	CONSTRAINT azure_keyvault_vault_access_policies_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (vault_cq_id) REFERENCES azure_keyvault_vaults(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_keyvault_vault_private_endpoint_connections" (
	...
	"provisioning_state" text,
	CONSTRAINT azure_keyvault_vault_private_endpoint_connections_pk PRIMARY KEY(vault_cq_id,private_endpoint_id),
	UNIQUE(cq_id),
	FOREIGN KEY (vault_cq_id) REFERENCES azure_keyvault_vaults(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_keyvault_vault_keys" (
	...
	"tags" jsonb,
	"managed" boolean,
	CONSTRAINT azure_keyvault_vault_keys_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (vault_cq_id) REFERENCES azure_keyvault_vaults(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_keyvault_vault_secrets" (
	...
	"content_type" text,
	"managed" boolean,
	CONSTRAINT azure_keyvault_vault_secrets_pk PRIMARY KEY(vault_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (vault_cq_id) REFERENCES azure_keyvault_vaults(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_monitor_activity_log_alerts" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_monitor_activity_log_alerts_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_monitor_activity_log_alert_conditions" (
	...
	"field" text,
	"equals" text,
	CONSTRAINT azure_monitor_activity_log_alert_conditions_pk PRIMARY KEY(activity_log_alert_cq_id,field),
	UNIQUE(cq_id),
	FOREIGN KEY (activity_log_alert_cq_id) REFERENCES azure_monitor_activity_log_alerts(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_monitor_activity_log_alert_action_groups" (
	...
	CONSTRAINT azure_monitor_activity_log_alert_action_groups_pk PRIMARY KEY(activity_log_alert_cq_id,action_group_id),
	UNIQUE(cq_id),
	FOREIGN KEY (activity_log_alert_cq_id) REFERENCES azure_monitor_activity_log_alerts(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_monitor_activity_logs" (
	...
	"subscription_id" text,
	"tenant_id" text,
	CONSTRAINT azure_monitor_activity_logs_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_monitor_diagnostic_settings" (
	...
	"type" text,
	"resource_uri" text,
	CONSTRAINT azure_monitor_diagnostic_settings_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_monitor_diagnostic_setting_metrics" (
	...
	CONSTRAINT azure_monitor_diagnostic_setting_metrics_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (diagnostic_setting_cq_id) REFERENCES azure_monitor_diagnostic_settings(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_monitor_diagnostic_setting_logs" (
	...
	"retention_policy_enabled" boolean,
	"retention_policy_days" integer,
	CONSTRAINT azure_monitor_diagnostic_setting_logs_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (diagnostic_setting_cq_id) REFERENCES azure_monitor_diagnostic_settings(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_monitor_log_profiles" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_monitor_log_profiles_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_mysql_servers" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_mysql_servers_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_mysql_server_private_endpoint_connections" (
	...
	"provisioning_state" text,
	CONSTRAINT azure_mysql_server_private_endpoint_connections_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_mysql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_mysql_server_configurations" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_mysql_server_configurations_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_mysql_servers(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_network_public_ip_addresses" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_network_public_ip_addresses_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_network_security_groups" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_network_security_groups_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_network_security_group_security_rules" (
	...
	"type" text,
	"id" text,
	CONSTRAINT azure_network_security_group_security_rules_pk PRIMARY KEY(security_group_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (security_group_cq_id) REFERENCES azure_network_security_groups(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_network_security_group_flow_logs" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_network_security_group_flow_logs_pk PRIMARY KEY(security_group_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (security_group_cq_id) REFERENCES azure_network_security_groups(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_network_security_group_default_security_rules" (
	...
	"type" text,
	"id" text,
	CONSTRAINT azure_network_security_group_default_security_rules_pk PRIMARY KEY(security_group_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (security_group_cq_id) REFERENCES azure_network_security_groups(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_network_virtual_networks" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_network_virtual_networks_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_network_virtual_network_subnets" (
	...
	"etag" text,
	"id" text,
	CONSTRAINT azure_network_virtual_network_subnets_pk PRIMARY KEY(virtual_network_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (virtual_network_cq_id) REFERENCES azure_network_virtual_networks(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_network_virtual_network_peerings" (
	...
	"etag" text,
	"id" text,
	CONSTRAINT azure_network_virtual_network_peerings_pk PRIMARY KEY(virtual_network_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (virtual_network_cq_id) REFERENCES azure_network_virtual_networks(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_network_watchers" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_network_watchers_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_postgresql_servers" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_postgresql_servers_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_postgresql_server_private_endpoint_connections" (
	...
	"private_link_service_connection_state_actions_required" text,
	"provisioning_state" text,
	CONSTRAINT azure_postgresql_server_private_endpoint_connections_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_postgresql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_postgresql_server_configurations" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_postgresql_server_configurations_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_postgresql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_postgresql_server_firewall_rules" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_postgresql_server_firewall_rules_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_postgresql_servers(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_resources_groups" (
	...
	"managed_by" text,
	"tags" jsonb,
	CONSTRAINT azure_resources_groups_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_resources_policy_assignments" (
	...
	"identity_tenant_id" text,
	"identity_type" text,
	CONSTRAINT azure_resources_policy_assignments_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_security_auto_provisioning_settings" (
	...
	"name" text,
	"resource_type" text,
	CONSTRAINT azure_security_auto_provisioning_settings_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_security_contacts" (
	...
	"name" text,
	"resource_type" text,
	CONSTRAINT azure_security_contacts_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_security_pricings" (
	...
	"name" text,
	"resource_type" text,
	CONSTRAINT azure_security_pricings_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_security_settings" (
	...
	"resource_type" text,
	"enabled" boolean,
	CONSTRAINT azure_security_settings_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_sql_servers" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_servers_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_sql_databases" (
	...
	CONSTRAINT azure_sql_databases_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
...
CREATE TABLE IF NOT EXISTS "azure_sql_database_db_blob_auditing_policies" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_database_db_blob_auditing_policies_pk PRIMARY KEY(database_cq_id,id),
	UNIQUE(cq_id),
...
CREATE TABLE IF NOT EXISTS "azure_sql_database_db_threat_detection_policies" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_database_db_threat_detection_policies_pk PRIMARY KEY(database_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (database_cq_id) REFERENCES azure_sql_databases(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_sql_database_db_vulnerability_assessments" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_database_db_vulnerability_assessments_pk PRIMARY KEY(database_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (database_cq_id) REFERENCES azure_sql_databases(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_sql_server_encryption_protectors" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_server_encryption_protectors_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_sql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_sql_server_private_endpoint_connections" (
	...
	"private_link_service_connection_state_actions_required" text,
	"provisioning_state" text,
	CONSTRAINT azure_sql_server_private_endpoint_connections_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_sql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_sql_server_firewall_rules" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_server_firewall_rules_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_sql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_sql_server_admins" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_server_admins_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_sql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_sql_server_db_blob_auditing_policies" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_server_db_blob_auditing_policies_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_sql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_sql_server_devops_audit_settings" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_server_devops_audit_settings_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_sql_servers(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_sql_server_vulnerability_assessments" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_sql_server_vulnerability_assessments_pk PRIMARY KEY(server_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (server_cq_id) REFERENCES azure_sql_servers(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_storage_accounts" (
	...
	CONSTRAINT azure_storage_accounts_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_storage_account_network_rule_set_virtual_network_rules" (
	...
	"action" text,
	"state" text,
	CONSTRAINT azure_storage_account_network_rule_set_virtual_network_rules_pk PRIMARY KEY(account_cq_id,virtual_network_resource_id),
	UNIQUE(cq_id),
	FOREIGN KEY (account_cq_id) REFERENCES azure_storage_accounts(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_storage_account_network_rule_set_ip_rules" (
	...
	"action" text,
	CONSTRAINT azure_storage_account_network_rule_set_ip_rules_pk PRIMARY KEY(account_cq_id,ip_address_or_range),
	UNIQUE(cq_id),
	FOREIGN KEY (account_cq_id) REFERENCES azure_storage_accounts(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_storage_account_private_endpoint_connections" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_storage_account_private_endpoint_connections_pk PRIMARY KEY(account_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (account_cq_id) REFERENCES azure_storage_accounts(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_storage_containers" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_storage_containers_pk PRIMARY KEY(account_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (account_cq_id) REFERENCES azure_storage_accounts(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_storage_blob_services" (
	...
	"name" text,
	"type" text,
	CONSTRAINT azure_storage_blob_services_pk PRIMARY KEY(account_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (account_cq_id) REFERENCES azure_storage_accounts(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_storage_blob_service_cors_rules" (
	...
	CONSTRAINT azure_storage_blob_service_cors_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (blob_service_cq_id) REFERENCES azure_storage_blob_services(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "azure_subscription_subscriptions" (
	...
	CONSTRAINT azure_subscription_subscriptions_pk PRIMARY KEY(id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "azure_web_apps" (
	...
	"type" text,
	"tags" jsonb,
	CONSTRAINT azure_web_apps_pk PRIMARY KEY(subscription_id,id),
	UNIQUE(cq_id)
);
CREATE TABLE IF NOT EXISTS "azure_web_app_host_name_ssl_states" (
	...
	"to_update" boolean,
	"host_type" text,
	CONSTRAINT azure_web_app_host_name_ssl_states_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (app_cq_id) REFERENCES azure_web_apps(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_web_app_publishing_profiles" (
	...
	"user_name" text,
	"user_pwd" text,
	CONSTRAINT azure_web_app_publishing_profiles_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (app_cq_id) REFERENCES azure_web_apps(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "azure_web_app_auth_settings" (
	...
	"kind" text,
	"type" text,
	CONSTRAINT azure_web_app_auth_settings_pk PRIMARY KEY(app_cq_id,id),
	UNIQUE(cq_id),
	FOREIGN KEY (app_cq_id) REFERENCES azure_web_apps(cq_id) ON DELETE CASCADE
);
