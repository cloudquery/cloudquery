...
SELECT setup_tsdb_child('azure_compute_virtual_machine_scale_set_os_profile_secrets', 'virtual_machine_scale_set_cq_id', 'azure_compute_virtual_machine_scale_sets', 'cq_id');
...
SELECT setup_tsdb_child('azure_compute_virtual_machine_scale_set_extensions', 'virtual_machine_scale_set_cq_id', 'azure_compute_virtual_machine_scale_sets', 'cq_id');
...
CREATE TABLE IF NOT EXISTS "azure_container_registries" (
	...
	"location" text,
	"tags" jsonb,
	CONSTRAINT azure_container_registries_pk PRIMARY KEY(cq_fetch_date,subscription_id,id),
	UNIQUE(cq_fetch_date,cq_id)
);
...
SELECT setup_tsdb_child('azure_container_registry_network_rule_set_virtual_network_rules', 'registry_cq_id', 'azure_container_registries', 'cq_id');
...
SELECT setup_tsdb_child('azure_container_registry_network_rule_set_ip_rules', 'registry_cq_id', 'azure_container_registries', 'cq_id');
...
SELECT setup_tsdb_child('azure_container_registry_replications', 'registry_cq_id', 'azure_container_registries', 'cq_id');
...
SELECT setup_tsdb_child('azure_datalake_analytics_account_data_lake_store_accounts', 'analytics_account_cq_id', 'azure_datalake_analytics_accounts', 'cq_id');
...
SELECT setup_tsdb_child('azure_datalake_analytics_account_storage_accounts', 'analytics_account_cq_id', 'azure_datalake_analytics_accounts', 'cq_id');
...
SELECT setup_tsdb_child('azure_datalake_analytics_account_compute_policies', 'analytics_account_cq_id', 'azure_datalake_analytics_accounts', 'cq_id');
...
SELECT setup_tsdb_child('azure_datalake_analytics_account_firewall_rules', 'analytics_account_cq_id', 'azure_datalake_analytics_accounts', 'cq_id');
...
SELECT setup_tsdb_child('azure_datalake_storage_account_firewall_rules', 'storage_account_cq_id', 'azure_datalake_storage_accounts', 'cq_id');
...
SELECT setup_tsdb_child('azure_datalake_storage_account_virtual_network_rules', 'storage_account_cq_id', 'azure_datalake_storage_accounts', 'cq_id');
...
SELECT setup_tsdb_child('azure_datalake_storage_account_trusted_id_providers', 'storage_account_cq_id', 'azure_datalake_storage_accounts', 'cq_id');
...
SELECT setup_tsdb_child('azure_sql_managed_database_vulnerability_assessments', 'managed_database_cq_id', 'azure_sql_managed_databases', 'cq_id');
...
SELECT setup_tsdb_child('azure_sql_managed_database_vulnerability_assessment_scans', 'managed_database_cq_id', 'azure_sql_managed_databases', 'cq_id');
...
SELECT setup_tsdb_child('azure_sql_managed_instance_private_endpoint_connections', 'managed_instance_cq_id', 'azure_sql_managed_instances', 'cq_id');
...
SELECT setup_tsdb_child('azure_sql_managed_instance_vulnerability_assessments', 'managed_instance_cq_id', 'azure_sql_managed_instances', 'cq_id');
...
SELECT setup_tsdb_child('azure_sql_managed_instance_encryption_protectors', 'managed_instance_cq_id', 'azure_sql_managed_instances', 'cq_id');
...
SELECT setup_tsdb_child('azure_sql_database_db_vulnerability_assessment_scans', 'database_cq_id', 'azure_sql_databases', 'cq_id');
