...
\echo :check_id
\i queries/network/asc_unprotectedendpoints_audit.sql
\set check_id "0858.09m1Organizational.4 - 09.m - 2"
\echo :check_id
\i queries/compute/virtual_machines_without_jit_network_access_policy.sql
...
\echo :check_id
\i queries/storage/accounts_with_not_restricted_asscess.sql
