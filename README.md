...
- **Attack Surface Management**: Open source solution for continuous discovery, analysis and monitoring of potential attack vectors that make up an organization's attack surface
