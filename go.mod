...
require github.com/cloudquery/cloudquery/cli/v6 v6.18.2
...
require (
	...
	github.com/cloudquery/plugin-sdk/v4 v4.79.0 // indirect
	...
	go.opentelemetry.io/collector/receiver/otlpreceiver v0.116.0 // indirect
