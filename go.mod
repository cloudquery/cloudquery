...
require github.com/cloudquery/cloudquery/cli v0.32.12
...
require (
	...
	github.com/cloudquery/plugin-sdk/v4 v4.69.0 // indirect
...
replace github.com/cloudquery/cloudquery/cli => ./cli
