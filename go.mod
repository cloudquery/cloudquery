...
require github.com/cloudquery/cloudquery/cli/v6 v6.35.5
...
require (
	...
	github.com/cloudquery/plugin-sdk/v4 v4.95.1 // indirect
	...
	go.opentelemetry.io/collector/receiver/otlpreceiver v0.148.0 // indirect
