...
// pflag doesn't support Enum flag type yet (or basically set of strings)
// See discussion and answer here https://github.com/spf13/pflag/issues/236#issuecomment-931600452
