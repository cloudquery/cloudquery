...
If you are also interested in setting up an AWS infrastructure data lake using Glue and Athena, like Hexagon, you can follow our how-to guide: [How to Load Infrastructure Data into AWS Athena](https://www.cloudquery.io/blog/how-to-load-infrastructure-data-into-athena). Or if you have any other questions or comments, we are always happy to chat on our [Community](https://community.cloudquery.io).