...
export const components = {
  ...
  IntegrationDestination: ({ source, destination, isOfficialSource, isOfficialDestination, sourceHasAuth, destHasAuth }) => {
    const SourceConfiguration = isOfficialSource ? dynamic(() => import(`../../components/mdx/plugins/source/${source}/${destination}/_configuration.md`)) : null
    const DestinationConfiguration = isOfficialDestination ? dynamic(() =>import(`../../components/mdx/plugins/destination/${destination}/_configuration.md`)) : null
    const SourceAuthentication = sourceHasAuth ? dynamic(() => import(`../../components/mdx/plugins/source/${source}/_authentication.md`)) : null
    const DestinationAuthentication = destHasAuth ? dynamic(() => import(`../../components/mdx/plugins/destination/${destination}/_authentication.md`)) : null
    const SyncCommand = dynamic(() => import(`../../components/mdx/plugins/source/${source}/${destination}/_sync.md`))
