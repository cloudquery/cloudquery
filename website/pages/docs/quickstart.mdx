...
spec:
  ...
  ## This is an alias so it should be unique if you have number of postgresql destination plugins.
  ## For example, you can have postgresql-1 and postgresql-2 destinations with different configurations.
  name: "postgresql"

  ## Optinal. Where to search for the plugin. Default: "github". Options: "github", "local", "grpc"
  # registry: "github"

  ## Required. path for the plugin.".
  ## If registry is "github" path should be "repo/name".
  ## If registry is "local", path is path to binary. Example: "~/path/to/plugin/binary".
  ## If registry is "grpc", then it should be address of the plugin (usually useful in debug). Example: "localhost:7777".
...
spec:
  ...
  ## For example, you can have aws_1 and aws_2 sources with different configurations.
  name: "aws"
