...
:::callout{type="info"}
CloudQuery Cloud is currently in beta. Not all functionality may be available. See the [limitations](#limitations-of-managed-syncs-compared-to-self-hosted) section below.
:::
