...
|------------------------|------------------------------------------------------------------------------------------|-------------------------------------------------------------------|--------------------------------------------------------------|--------------------------------------------------------------------|
| Source Plugin SDK      | Yes ([Guide](/docs/developers/creating-new-plugin/go-source))                            | Yes ([Guide](/docs/developers/creating-new-plugin/python-source)) | Soon ([Repo](https://github.com/cloudquery/plugin-sdk-java)) | Soon ([Repo](https://github.com/cloudquery/plugin-sdk-javascript)) |
