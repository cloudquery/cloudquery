...
|------------------------|------------------------------------------------------------------------------------------|-------------------------------------------------------------------|--------------------------------------------------------------|--------------------------------------------------------------------|
| Source Plugin SDK      | Yes ([Guide](/docs/developers/creating-new-plugin/go-source))                            | Yes ([Guide](/docs/developers/creating-new-plugin/python-source)) | Soon ([Source](https://github.com/cloudquery/plugin-sdk-java)) | Soon ([Source](https://github.com/cloudquery/plugin-sdk-javascript)) |
| Destination Plugin SDK | Yes ([Examples](https://github.com/cloudquery/cloudquery/tree/main/plugins/destination)) | No                                                                | No                                                           | No                                                                 |

The Go SDK is the most mature and is used to develop most plugins that ship with CloudQuery. The Python SDK is currently in beta and is being used to develop a number of plugins, most notably Square and Typeform. The Java and JavaScript SDKs are currently in development and will be released soon.