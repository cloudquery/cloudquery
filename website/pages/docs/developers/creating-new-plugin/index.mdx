...
| ---------------------- | ---------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------- |
| Source Plugin SDK      | Yes ([Guide](/docs/developers/creating-new-plugin/go-source))                            | Yes ([Guide](/docs/developers/creating-new-plugin/python-source)) | Soon ([Source](https://github.com/cloudquery/plugin-sdk-java)) | Yes ([Source](https://github.com/cloudquery/plugin-sdk-javascript)) |
| Destination Plugin SDK | Yes ([Examples](https://github.com/cloudquery/cloudquery/tree/main/plugins/destination)) | No                                                                | No                                                             | No                                                                  |
| Release stage          | GA                                                                                       | Preview                                                           | In Development                                                 | Preview                                                             |
