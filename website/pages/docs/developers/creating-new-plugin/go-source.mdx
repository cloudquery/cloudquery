...
1. Within the plugin client initialize the state client using `state.NewConnectedClient` or `state.NewConnectedClientWithOptions` ([see example](https://github.com/cloudquery/cloudquery/blob/5d23e729faeb4ccff65b74ca1326876f599e4e57/plugins/source/hackernews/resources/plugin/client.go#L37)).
...
- The [XKCD Source Plugin](https://github.com/cloudquery/cloudquery/tree/main/plugins/source/xkcd) contains the full code from this tutorial.
...
- The [K8s Source Plugin](https://github.com/cloudquery/cloudquery/tree/plugins-source-k8s-v6.2.4/plugins/source/k8s) is a good example of a more complex plugin with many tables and mock tests.
