...
- The [K8s Source Plugin](https://github.com/cloudquery/cloudquery/tree/main/plugins/source/k8s) is a good example of a more complex plugin with many tables and mock tests.
