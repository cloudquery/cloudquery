...
As the JavaScript SDK is still new, we don't yet have a plugin scaffold generator. For now, we recommend starting by copying the code from an [existing JavaScript plugin](https://github.com/cloudquery/cloudquery/tree/cb4a46ed9bdd205f19f3d92636a40914aedc6b24/plugins/source/airtable).
