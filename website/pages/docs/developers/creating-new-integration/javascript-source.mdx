...
As the JavaScript SDK is still new, we don't yet have a integration scaffold generator. For now, we recommend starting by copying the code from an [existing JavaScript integration](https://github.com/cloudquery/cloudquery/tree/main/plugins/source/airtable).
