...
- `companies`
  - `properties` ([]string, optional. Default: "[]")
    ...
    Object Properties to be retrieved from the object Companies on the HubSpot Source

- `contacts`
  - `properties` ([]string, optional. Default: "[]")

    Object Properties to be retrieved from the object Contacts on the HubSpot Source

- `deals`
  - `properties` ([]string, optional. Default: "[]")

    Object Properties to be retrieved from the object Deals on the HubSpot Source

- `line_items`
  - `properties` ([]string, optional. Default: "[]")

    Object Properties to be retrieved from the object Line Items on the HubSpot Source

- `products`
  - `properties` ([]string, optional. Default: "[]")

    Object Properties to be retrieved from the object Products on the HubSpot Source

- `quotes`
  - `properties` ([]string, optional. Default: "[]")

    Object Properties to be retrieved from the object Quotes on the HubSpot Source

- `tickets`
  - `properties` ([]string, optional. Default: "[]")

    Object Properties to be retrieved from the object Tickets on the HubSpot Source
