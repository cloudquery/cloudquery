...
This plugins also supports CDC via Postgres logical replication which enables keeping your Postgres up to date with any destination just by subscribing to changes.
