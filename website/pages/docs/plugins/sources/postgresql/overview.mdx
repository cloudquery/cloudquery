...
The CloudQuery PostgreSQL plugin syncs your PostgreSQL database to any of the supported CloudQuery destinations (e.g. PostgreSQL, Snowflake, BigQuery, …).
This plugins also supports CDC via PostgreSQL logical replication which enables keeping your PostgreSQL up to date with any destination just by subscribing to changes.
