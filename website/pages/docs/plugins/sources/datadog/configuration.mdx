...
- `name` (`string`): example_account # Required. Name to distinguish accounts

  Account name.

- `api_key` (`string`): example_account # Required. Name to distinguish accounts

  DataDog API key.

- `app_key` (`string`): example_account # Required. Name to distinguish accounts
