...
<Callout type="info">
This feature is currently in a closed preview. Signup for access using this [form](https://admin.typeform.com/form/Dvdn6P2u/create?block=a48d83b4-e41c-4e1c-a980-89f769933f7e)
</Callout>

# Event Based Sync

AWS CloudTrail enables users to get an audit log of events occurring within their account. By subscribing to a stream of AWS Cloudtrail events CloudQuery can trigger selective syncs to update just the singular resource that had a configuration change.
...
- Incremental table's state is not updated by event based syncs