...
- `start_time` (timestamp) 
  ...
  Defines the place in the stream where record processing should begin. By default, the time at which the sync began will be used.

- `event_based_sync_only` (`bool`) (default: `false`)
