...
- `connection_string` (string, required)
  ...
  Connection string to connect to the database in the format `oracle://<user<>:<password>@<server>:<port>/<service_name>`. See the [Go driver documentation](https://github.com/sijms/go-ora) for more details.
