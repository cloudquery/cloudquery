...
- `login_timeout` (`time.Duration`) (optional)

- `request_timeout` (`time.Duration`) (optional)

- `jwt_expire_timeout` (`time.Duration`) (optional)

- `client_timeout` (`time.Duration`) (optional)
