...
Azure CosmosDB has special requirements for connecting to the database:

 - For endpoint, use `wss://<account-name>.gremlin.cosmos.azure.com:443`
 - For username, use ``/dbs/<db>/colls/<coll>`` where <db> is your database name and <coll> is your collection name.
 - Use the specified Primary Key as the authentication password.

Please refer to the relevant [CosmosDB documentation](https://learn.microsoft.com/en-us/azure/cosmos-db/gremlin/quickstart-console#ConnectAppService) on details.
-->
...
- `username` (string, optional)
  ...
  Username to connect to the database. <!-- For Azure CosmosDB, use `/dbs/<db>/colls/<coll>` here. -->

- `password` (string, optional)

  Password to connect to the database. <!-- For Azure CosmosDB, use your Primary Key here. -->
