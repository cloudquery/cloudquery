...
CloudQuery has a pluggable architecture that communicates with plugins communicating over [gRPC](https://github.com/cloudquery/plugin-pb). Each plugin can implement to be a source, destination or both.
