...
- **Unlimited scale:** CloudQuery plugins are completely stateless and can be scaled horizontally on any platform, such as [VMs](/docs/deployment/google-cloud-vm), [Kubernetes](/docs/deployment/kubernetes), or batch jobs.
...
- **Blazing fast**: CloudQuery is optimized for performance, utilizing the excellent Go concurrency model with lightweight goroutines and [streaming your data over GRPC](/docs/developers/architecture).
- **Open source framework**: Develop plugins in [Go](/docs/developers/creating-new-plugin/go-source), [Python](/docs/developers/creating-new-plugin/python-source), [Java](/docs/developers/creating-new-plugin/java-source), or [JavaScript](/docs/developers/creating-new-plugin/javascript-source) using the [open source CloudQuery SDK](https://github.com/cloudquery).
...
- Learn the CloudQuery [core concepts](/docs/core-concepts/plugins).
