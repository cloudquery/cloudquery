...
CloudQuery is the [open-source](https://github.com/cloudquery/cloudquery)
data integration platform for security and infrastructure teams.

CloudQuery extracts, transforms and loads configuration from cloud APIs to
variety of supported destination such as database, data lake, or streaming platform
