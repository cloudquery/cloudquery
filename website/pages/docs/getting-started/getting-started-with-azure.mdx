...
After installing CloudQuery,
you need to generate configuration that will describe at least one source plugin to extract data from and at least one
destination plugins to save the data.
...
CloudQuery needs to be authenticated with your Azure account in order to `sync` information from your cloud setup to your
