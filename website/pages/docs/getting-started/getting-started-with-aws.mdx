...
CloudQuery needs to be authenticated with your AWS account in order to `sync` information from your cloud setup to your
...
Once `cloudquery.yml` is generated and you are authenticated with AWS, run the following command to sync the resources.
