...
If it’s your first time using CloudQuery we suggest you first run it locally to get familiar with the tool, take a look at our [quickstart guide](/docs/quickstart) and [AWS source plugin](https://hub.cloudquery.io/plugins/source/cloudquery/aws).
...
- **Cloud Marketplaces:**
  - [https://aws.amazon.com/solutions/implementations/apache-superset/](https://aws.amazon.com/solutions/implementations/apache-superset/)
