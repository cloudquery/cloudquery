...
If it’s your first time using CloudQuery we suggest you first run it locally to get familiar with the tool, take a look at our [quickstart guide](/docs/quickstart) and [Azure source plugin](https://hub.cloudquery.io/plugins/source/cloudquery/azure).
...
We can still use the PostgreSQL connector by downloading the Power BI Desktop from [here](https://www.microsoft.com/en-us/download/details.aspx?id=58494).
