...
Configure a destination for CloudQuery to use to store the data. For this tutorial we will use Postgresql, but many other destinations are [available here](https://hub.cloudquery.io/plugins/destination)
...
Configure CloudQuery's AWS [source plugin](https://hub.cloudquery.io/plugins/source/cloudquery/aws) to use the LocalStack endpoint.
