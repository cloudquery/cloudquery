...
In this guide, we will use Neo4j as a destination and AWS as a source.  For more information on how to set those up, see our documentation on [Neo4j](https://hub.cloudquery.io/plugins/destination/cloudquery/neo4j) and [AWS](https://hub.cloudquery.io/plugins/source/cloudquery/aws).
...
You can get started with CloudQuery without any installation or deployment using our [Managed Syncs](/docs/quickstart/managed).

To use CloudQuery locally, check out our [quickstart guide](/docs/quickstart) and [AWS source plugin](https://hub.cloudquery.io/plugins/source/cloudquery/aws) for how to configure CloudQuery.
...
For more information on configuration files, see [AWS source configuration](https://hub.cloudquery.io/plugins/source/cloudquery/aws/configuration) and [Neo4j destination configuration](https://hub.cloudquery.io/plugins/destination/cloudquery/neo4j)
