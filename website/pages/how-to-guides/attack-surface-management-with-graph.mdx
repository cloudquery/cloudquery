...
To get started with CloudQuery, check out our [quickstart guide](/docs/quickstart) and [AWS source plugin](https://hub.cloudquery.io/plugins/source/cloudquery/aws) for how to configure CloudQuery and run it locally on your machine.
