...
AWS Backup supports [multiple resources in AWS](https://docs.aws.amazon.com/aws-backup/latest/devguide/whatisbackup.html) including RDS, EBS, S3, EFS, Redshift, Timestream, Neptune, DocumentDB, and more.  In this reference example, we'll sync data about AWS Backup, AWS S3, AWS DynamoDB, and AWS EC2.  CloudQuery can be customized to sync data from other [infrastructure in AWS](/docs/plugins/sources/aws/tables) as needed.
...
![Backed Up Resources Grouped by Resource Type and Account](/images/how-to-guides/manage-resilience-with-aws-backup/backupupresourcesgroupedcount.png)
