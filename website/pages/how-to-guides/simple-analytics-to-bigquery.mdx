...
You can find the latest version in the [BigQuery destination plugin documentation](https://hub.cloudquery.io/plugins/destination/cloudquery/bigquery). There are also a few more configuration options you may want to consider, like partitioning based on sync time.
