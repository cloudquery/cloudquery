...
If it’s your first time using CloudQuery we suggest you first run it locally to get familiar with the tool, take a look at our [quickstart guide](/docs/quickstart) and [GCP source plugin](https://hub.cloudquery.io/plugins/source/cloudquery/gcp).
