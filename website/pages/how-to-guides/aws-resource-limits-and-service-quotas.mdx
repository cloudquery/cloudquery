...
To start with the sync, check out the [AWS Configuration Guide](https://hub.cloudquery.io/plugins/source/cloudquery/aws).  We'll start with the following `aws.yml` source configuration file.  We recommend adjusting your configuration file and tables synced to meet your specific needs.
