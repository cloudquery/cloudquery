...
Next, create a configuration file that specifies the cloud providers and resources you want to include in your infrastructure data lake. For example, you might include [AWS](https://docs.cloudquery.io/integrations/aws), [Google Cloud](https://docs.cloudquery.io/integrations/gcp), and [Azure](https://docs.cloudquery.io/integrations/azure), along with their respective resource types such as EC2 instances, S3 buckets, and virtual machines. You can find all supported cloud providers and resources in [CloudQuery integrations](https://docs.cloudquery.io/integrations).

## Setting up sources

### Example with AWS, Azure and MongoDB

- Go to the CloudQuery integrations page for [AWS to MongoDB](https://docs.cloudquery.io/integrations/aws/mongodb) and follow it to create `aws.yaml` and `mongodb.yaml` files.

- Go to the CloudQuery integrations page for [Azure to MongoDB](https://docs.cloudquery.io/integrations/azure/mongodb) and follow it to create `azure.yaml` file. `mongodb.yaml` file should have the same content as the previous one.
