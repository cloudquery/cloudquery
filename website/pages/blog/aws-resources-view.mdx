...
<Callout type="info">
**Update (June 2023)**: You can find the latest documentation for the [AWS resources view in the CloudQuery AWS source plugin documentation](https://hub.cloudquery.io/plugins/source/cloudquery/aws). There are also similar views for [GCP](https://hub.cloudquery.io/plugins/source/cloudquery/gcp) and [Azure](https://hub.cloudquery.io/plugins/source/cloudquery/azure).
</Callout>
...
There are many views we can create on top of CloudQuery that make it easier to query our data, some examples can be found in our [policies](https://hub.cloudquery.io/addons/transformation). We are working on more awesome views that will make your life even easier, such as `aws_policies`
