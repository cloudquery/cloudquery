...
<Callout type="info">
**Update (June 2023)**: You can find the latest documentation for the [AWS resources view in the CloudQuery AWS source plugin documentation](/docs/plugins/sources/aws/views)
</Callout>
