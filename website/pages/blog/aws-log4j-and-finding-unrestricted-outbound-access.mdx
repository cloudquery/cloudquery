...
The vulnerability in the popular log4j library is a critical remote code execution described in a simple and understandable way in the [Swiss Government Emergency and Response site](https://github.com/govcert-ch/website/blob/8e3128159a0e078a1ad07317e191f236c54b8e11/content/blog/zero-day-exploit-targeting-popular-java-library-log4j/post.md). The main takeaway here is that for an application to be exploitable it has to answer 3 requirements:
