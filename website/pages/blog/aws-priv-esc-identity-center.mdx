...
For more detailed instructions on how to configure CloudQuery to sync from AWS to PostgreSQL, please follow our guide [here](https://docs.cloudquery.io/integrations/aws/postgresql).
