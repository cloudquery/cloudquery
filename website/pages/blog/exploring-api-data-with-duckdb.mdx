...
First we create a CloudQuery config file called `homebrew.yml`, in which we'll put both the Homebrew source and the DuckDB destination configuration:
