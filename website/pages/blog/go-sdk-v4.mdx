...
Go is not a great language for frameworks, so we made the Plugin SDK very lightweight and moved other heavy functionality to its own sub-packages, which makes it easier to extend and test.
