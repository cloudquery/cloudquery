...
- [GCP Source Plugin](https://hub.cloudquery.io/plugins/source/cloudquery/gcp)
- [BigQuery Destination Plugin](https://hub.cloudquery.io/plugins/destination/cloudquery/bigquery)

## Syncing data

First, we need to sync our GCP data with CloudQuery to the same BigQuery dataset we synced our billing data to. To do that we will use the following CloudQuery configuration file (For full config reference, checkout the [GCP Source Plugin](https://hub.cloudquery.io/plugins/source/cloudquery/gcp) and [BigQuery Destination Plugin](https://hub.cloudquery.io/plugins/destination/cloudquery/bigquery)):
