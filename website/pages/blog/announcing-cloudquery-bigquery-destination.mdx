...
Syncing data to BigQuery can be done as with any other destination plugin, so check out our [Quickstart](/docs/quickstart) and [BigQuery plugin documentation](https://hub.cloudquery.io/plugins/destination/cloudquery/bigquery) for instructions on how to get started.
