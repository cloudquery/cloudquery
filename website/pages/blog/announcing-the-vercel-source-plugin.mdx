...
Take a look at our [Configuration](https://hub.cloudquery.io/plugins/source/cloudquery/vercel) section to configure required credentials for the plugin.
...
Vercel also provides an [auto-renewal facility](https://vercel.com/docs/projects/domains/renew-a-domain) which will automatically renew your domain registration when it's about to expire.
