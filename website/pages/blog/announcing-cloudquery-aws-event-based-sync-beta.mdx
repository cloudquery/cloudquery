...
:::callout{type="info"}
This feature is in development. Find the full list of supported events in our [AWS Event-based Sync](/docs/plugins/sources/aws/event-based-sync#supported-services-and-events) documentation.
:::
