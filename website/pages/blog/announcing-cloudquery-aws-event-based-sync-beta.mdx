...
The way CloudQuery has been initially designed was to sync all data on demand to give you the full control over what to sync, when, and how often. This approach makes CloudQuery easy to set up and use.
