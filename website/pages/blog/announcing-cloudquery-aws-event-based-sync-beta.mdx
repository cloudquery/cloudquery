...
:::callout{type="info"}
This feature is in development. Find the full list of supported events in our [AWS Event-based Sync](https://hub.cloudquery.io/plugins/source/cloudquery/aws) documentation.
:::
...
[Read the docs](https://hub.cloudquery.io/plugins/source/cloudquery/aws)
