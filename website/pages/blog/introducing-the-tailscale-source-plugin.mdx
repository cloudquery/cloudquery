...
Take a look at our [Configuration](https://hub.cloudquery.io/plugins/source/cloudquery/tailscale#spec) section to configure required credentials for the plugin.
