...
By using CloudQuery, customers can sync infrastructure data from multiple sources to multiple destinations.  [CloudQuery enables customers to sync infrastructure data from AWS to Snowflake](https://docs.cloudquery.io/integrations/aws/snowflake), a popular data destination.
