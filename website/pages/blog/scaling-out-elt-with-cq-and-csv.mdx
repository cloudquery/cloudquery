...
<Callout type="info">
  ...
  The CSV plugin has now been deprecated in favor of the [File plugin](https://hub.cloudquery.io/plugins/destination/cloudquery/file). The File plugin supports CSV, JSON and Parquet formats.
