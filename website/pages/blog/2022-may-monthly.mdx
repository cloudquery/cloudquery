...
**Project Auto Discovery**: The [GCP Provider](https://hub.cloudquery.io/plugins/source)
...
CloudQuery supports six open-source security & compliance [policies](https://hub.cloudquery.io/addons/transformation) implemented
...
alerting and much more! To see more checkout the [documentation](https://hub.cloudquery.io/addons/transformation).
