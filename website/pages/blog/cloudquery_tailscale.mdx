...
{/* <!-- vale off --> */}
<Callout type="info">
**Update (July 2023)**: The Tailscale plugin is now a premium plugin. You can find more information about the pricing [here](/docs/plugins/sources/tailscale/overview).
</Callout>
{/* <!-- vale on --> */}
