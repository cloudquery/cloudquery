...
Other cool things once you have Tailscale configuration in your database/datalake is that you can join and query it with data from other CloudQuery [source plugins](https://www.cloudquery.io/docs/plugins/sources/overview).
