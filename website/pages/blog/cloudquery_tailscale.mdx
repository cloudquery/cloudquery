...
so you can have all your infrastructure data in one place and correlate between different services.
...
You can slice and dice Tailscale config data in many ways but this should give you a great starting point!