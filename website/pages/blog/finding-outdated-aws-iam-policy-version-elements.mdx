...
| VPC Endpoints | 2012 | Interface Endpoints (Did not test all) |
| AWS SAM | ? | - | 
| AWS Backup | None | - |
...
Legacy policy verions can be problematic for developers and application teams given the difference in interpretation by AWS.  
...
We have the following recommendations for AWS end users:
