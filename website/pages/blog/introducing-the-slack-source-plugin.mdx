...
We can also cross-reference user accounts against data from the [Okta plugin](https://hub.cloudquery.io/plugins/source/cloudquery/okta) to see if they should still have Slack access:
...
To get started syncing Slack data, see the [Slack source plugin documentation](https://hub.cloudquery.io/plugins/source/cloudquery/slack) for instructions.
