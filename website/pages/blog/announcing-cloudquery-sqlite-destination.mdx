...
If you don't want to run a database or docker, running SQLite as destination will be super performant similar to our [File destination plugin](/docs/plugins/destinations/file/overview) but with the ability to do complex queries and store everything in one file.
