...
We were heads down as we were adopting Apache Arrow as our in memory [data format](/blog/adopting-apache-arrow-at-cloudquery)!
...
* [Firestore](/docs/plugins/sources/firestore/overview) Thanks to to [@BubbaJoe](https://github.com/BubbaJoe) for initial contribution!
