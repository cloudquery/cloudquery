...
* [OracleDB](https://hub.cloudquery.io/plugins/source/cloudquery/oracledb)
* [Firestore](https://hub.cloudquery.io/plugins/source/cloudquery/firestore) Thanks to [@BubbaJoe](https://github.com/BubbaJoe) for initial contribution!
...
- AWS: 18 New [tables](https://hub.cloudquery.io/plugins/source/cloudquery/aws/tables):
...
- Azure: 39 New [tables](https://hub.cloudquery.io/plugins/source/cloudquery/azure/tables):
...
- GCP: New [Table](https://hub.cloudquery.io/plugins/source/cloudquery/gcp/tables):
  - `gcp_dns_resource_record_sets`

- Datadog: 3 [Tables](https://hub.cloudquery.io/plugins/source/cloudquery/datadog/tables):
  - `datadog_rum_events`
  - `datadog_slo_corrections`
  - `datadog_slos`

- Digital Ocean: 2 [Tables](https://hub.cloudquery.io/plugins/source/cloudquery/digitalocean/tables):
  - `digitalocean_load_balancers`
  - `digitalocean_regions`

- GitLab: 2 [Tables](https://hub.cloudquery.io/plugins/source/cloudquery/gitlab/tables):
  - `gitlab_group_billable_members`
  - `gitlab_project_members`

- Oracle: 5 [Tables](https://hub.cloudquery.io/plugins/source/cloudquery/oracle/tables):
...
- Snyk: 2 [Tables](https://hub.cloudquery.io/plugins/source/cloudquery/snyk/tables):
  - `snyk_groups`
  - `snyk_group_members`

- Stripe: 2 [Tables](https://hub.cloudquery.io/plugins/source/cloudquery/stripe/tables):
