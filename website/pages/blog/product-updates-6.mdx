...
- Azure: 39 New [tables](/docs/plugins/sources/azure/tables):
...
- Datadog: 3 [Tables](/docs/plugins/sources/datadog/tables):
  - `datadog_rum_events`
  - `datadog_slo_corrections`
  - `datadog_slos`

- Digital Ocean: 2 [Tables](/docs/plugins/sources/digitalocean/tables):
  - `digitalocean_load_balancers`
  - `digitalocean_regions`

- GitLab: 2 [Tables](/docs/plugins/sources/gitlab/tables):
  - `gitlab_group_billable_members`
  - `gitlab_project_members`

- Oracle: 5 [Tables](/docs/plugins/sources/oracle/tables):
...
- Snyk: 2 [Tables](/docs/plugins/sources/snyk/tables):
  - `snyk_groups`
  - `snyk_group_members`

- Stripe: 2 [Tables](/docs/plugins/sources/stripe/tables):
