...
To build and release the plugin for public use, you will need [Docker](https://docker.io) installed locally.
...
We will not start completely from scratch but rather use a template that just needs filling in the blanks. There is the[javascript-plugin-template]](https://github.com/cloudquery/javascript-plugin-template) starter repository that you can clone.
