...
We will not start completely from scratch but rather use a template that just needs filling in the blanks. I have published a starter [repository](https://github.com/cloudquery/cq-js-plugin-template) that you can clone.
