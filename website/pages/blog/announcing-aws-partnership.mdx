...
CloudQuery supports a variety of [source plugins](https://hub.cloudquery.io/plugins/source/cloudquery/overview) and [destination plugins](/docs/plugins/destinations/overview).  By using these source plugins and destinations, information from AWS configurations and deployments can be synced.  Additionally, infrastructure data from a variety of sources can be synced to AWS-related and hosted data destinations.
