...
CloudQuery supports a variety of [source plugins](https://hub.cloudquery.io/plugins/source/cloudquery/overview) and [destination plugins](https://hub.cloudquery.io/plugins/destination).  By using these source plugins and destinations, information from AWS configurations and deployments can be synced.  Additionally, infrastructure data from a variety of sources can be synced to AWS-related and hosted data destinations.
...
* [File (can sync from S3)](https://hub.cloudquery.io/plugins/source/cloudquery/file)

### Destinations

CloudQuery supports the following AWS-related destination plugins:

* [Amazon Kinesis Firehose](https://hub.cloudquery.io/plugins/destination/cloudquery/firehose)
* [Gremlin (AWS Neptune)](https://hub.cloudquery.io/plugins/destination/cloudquery/gremlin)
* RDS Compatible databases including [PostgreSQL](https://hub.cloudquery.io/plugins/destination/cloudquery/postgresql), [MySQL](https://hub.cloudquery.io/plugins/destination/cloudquery/mysql).
