...
CloudQuery has released the following updates to encryption resources to aid with Encryption discovery in AWS in addition to our [existing coverage of AWS](https://hub.cloudquery.io/plugins/source/cloudquery/aws) and [AWS resources](https://www.cloudquery.io/docs/plugins/sources/aws/tables):
