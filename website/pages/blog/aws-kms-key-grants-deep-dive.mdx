...
<BlogHeader/>
We recently published a [blog post](/blog/aws-encryption-and-multi-account-access) about Encryption in AWS and Multi-Account Access.  As a follow-up to that post, we’re focusing on encryption access in AWS and information on [how CloudQuery can help](https://hub.cloudquery.io/plugins/source) including how to audit access to those encryption keys and the underlying data to help assist with your security and compliance needs.

CloudQuery has released the following updates to encryption resources to aid with Encryption discovery in AWS in addition to our [existing coverage of AWS](https://hub.cloudquery.io/plugins/source/cloudquery/aws) and [AWS resources](https://hub.cloudquery.io/plugins/source/cloudquery/aws/tables):

- Support for [KMS Key Aliases](https://hub.cloudquery.io/plugins/source/cloudquery/aws/tables/aws_kms_aliases)
- Support for [KMS Key Grants](https://hub.cloudquery.io/plugins/source/cloudquery/aws/tables/aws_kms_key_grants)
- Support for [CloudHSMv2](https://hub.cloudquery.io/plugins/source/cloudquery/aws/tables/aws_cloudhsmv2_clusters)
...
[CloudQuery: Source Plugins](https://hub.cloudquery.io/plugins/source)
