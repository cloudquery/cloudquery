...
**Note**: The data world has become a complex landscape, full of acronyms and buzzwords. In this post we will give a birds-eye view and demystify all the terminology.
...
In this blog, we will explore the key components of the modern data stack, popular tools and technologies, and use cases they unlock, such as Customer-Data-Platform (CDP), "Infrastructure-Data-Platform" (IDP), and many other custom use cases that involve the above processes.

## What is a “Stack”?

A stack is a collection of technologies that combine to form a system. Usually, components of the stack can be swapped out for others. The modern data stack typically includes the following base components: **Data Sources**, **ELT**, **Data Storage**, **Data Transformation**, **Data Analysis, Monitoring** and **Data Visualization**. Though as with any engineering stack you can plug and play different tools at each component and use only some of the components, depending on your needs and use cases. We will also cover some optional components in the stack, such as Orchestration, Monitoring, Data Science and Reverse ETL.
