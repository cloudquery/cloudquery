...
and in this article we'll take a deep dive into the topic of logical replication (For running CloudQuery PostgreSQL CDC source plugin take a look at our [docs](../docs/plugins/source/postgresql/overview)).
