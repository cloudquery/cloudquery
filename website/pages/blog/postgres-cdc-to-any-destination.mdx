...
CDC (Change-Data-Capture) is a [term](https://en.wikipedia.org/wiki/Change_data_capture) used in a set of design patterns in databases where one can track changes to the data and act upon it.
