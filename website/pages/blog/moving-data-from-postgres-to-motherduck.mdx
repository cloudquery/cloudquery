...
Running a sync continuously from your local machine is not the most reliable way to sync data from Postgres. There are many options for getting your sync production-ready. For more information on this, see the [CloudQuery Deployment Documentation](/docs/deployment/overview). 