...
| AWS Trusted Advisor | Yes |trustedadvisor:SetOrganizationAccess |
...
Below is an example policy for allowing organization delegation management.  This policy can be modified to deny organizational management as needed.
