...
For this New official destination plugins support [auto migrations](/docs/advanced-topics/migrations) and [release stages](/docs/plugins/sources/overview#source-plugin-release-stages)
