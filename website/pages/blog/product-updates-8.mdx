...
- The AWS plugin has a new scheduler strategy that reduces the number of concurrent calls made to the account contact APIs in syncs with multiple tables. Read more about this in our documentation on [performance tuning](https://www.cloudquery.io/docs/advanced-topics/performance-tuning#use-a-different-scheduler).
