...
<Callout type="warning">
    Update (February 2023): While TimescaleDB is no longer supported, CloudQuery v1 supports `append` write mode, which can be used to create a historical view of your data. See the <a href="/docs/reference/destination-spec#write_mode">docs</a> for more information.
</Callout>
