...
* CSV. (Update 20 April 2023: CSV destination has now been replaced by the [File destination](https://www.cloudquery.io/docs/plugins/destinations/file/overview).) See [release blog](https://www.cloudquery.io/blog/scaling-out-elt-with-cq-and-csv).
