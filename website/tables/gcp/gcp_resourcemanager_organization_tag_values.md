# Table: gcp_resourcemanager_organization_tag_values
...
This table depends on [gcp_resourcemanager_organization_tag_keys](gcp_resourcemanager_organization_tag_keys).
