...
We recommend that you authenticate using the CloudQuery CLI. Once signed in, you can use CloudQuery with premium plugins up to a free quota and premium plugins in preview for free.

Authenticated users have also higher rate limits on plugin downloads per IP address.
