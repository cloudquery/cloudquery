...
The AWS authentication guide is located [here](https://hub.cloudquery.io/plugins/source/cloudquery/aws/latest/docs#authentication).

You can find authentication for other plugins in their corresponding [docs](https://hub.cloudquery.io/plugins/source).
