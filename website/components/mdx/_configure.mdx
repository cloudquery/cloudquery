...
Destination plugins define where you will be syncing your data to (See: [available destinations](/docs/plugins/destinations)).
...
Source plugins define the APIs you want to sync from (See [available sources](/docs/plugins/sources)).
