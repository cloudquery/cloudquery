...
import InitCommandWindow from './_configure-init-command-windows.mdx';
...
import SqliteCommandWindow from './_configure-sqlite-command-windows.mdx';
...
Run the following command to get the oldest 10 XKCD comics and their image URLs:
...
```
Barrel - Part 1|https://imgs.xkcd.com/comics/barrel_cropped_(1).jpg
Petit Trees (sketch)|https://imgs.xkcd.com/comics/tree_cropped_(1).jpg
Island (sketch)|https://imgs.xkcd.com/comics/island_color.jpg
Landscape (sketch)|https://imgs.xkcd.com/comics/landscape_cropped_(1).jpg
Blown apart|https://imgs.xkcd.com/comics/blownapart_color.jpg
Irony|https://imgs.xkcd.com/comics/irony_color.jpg
Girl sleeping (Sketch -- 11th grade Spanish class)|https://imgs.xkcd.com/comics/girl_sleeping_noline_(1).jpg
Red spiders|https://imgs.xkcd.com/comics/red_spiders_small.jpg
Serenity is coming out tomorrow|https://imgs.xkcd.com/comics/firefly.jpg
Pi Equals|https://imgs.xkcd.com/comics/pi.jpg
```