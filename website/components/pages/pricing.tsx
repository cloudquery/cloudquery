...
const tiers: PricingTier[] = [
    {
        ...
        attributes: {
            ...
            Communication: <><a href="https://community.cloudquery.io" className="text-blue-500 hover:text-blue-600">Public Community</a>, <a href="https://github.com/cloudquery/cloudquery/issues" className="text-blue-500 hover:text-blue-600">GitHub issues</a></>,
    ...
    },
    {
        ...
        attributes: {
            ...
            Limits: "No usage-based billing or limits on number of rows.",
            Communication: "Private channel in either Slack or Teams",
