...
```
  -h, --help                             help for sync
      ...
      --shard string                     Allows splitting the sync process into multiple shards. This feature is in Preview. Please provide feedback to help us improve it. For a list of supported plugins visit https://www.cloudquery.io/docs/advanced-topics/running-cloudquery-in-parallel
