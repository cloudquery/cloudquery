...
func NewClients(ctx context.Context, specs []*specs.Source, opts ...PluginOption) (Clients, error) {
...
func NewClient(ctx context.Context, spec specs.Source, opts ...PluginOption) (*Client, error) {
	c := Client{
