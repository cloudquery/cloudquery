...
# You can also filter which tables are included in the output. The default is all, you can override it with --filter to include only tables referenced in the spec
